...
class LinkAction extends UserAction{
	...
	public function keywordModules(){
		...
		array('module'=>'Storenew','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Storenew&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Storenew'],'canselected'=>1,'linkurl'=>'','keyword'=>'分销商城','askeyword'=>1),
		array('module'=>'Jingpai','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Storenew&a=jingpai&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Jingpai'],'canselected'=>1,'linkurl'=>'','keyword'=>'商城竞拍','askeyword'=>1),
	...
	public function modules(){
		...
		array('module'=>'Storenew','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Storenew&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Storenew'],'sub'=>1,'canselected'=>1,'linkurl'=>'','keyword'=>'分销商城','askeyword'=>1),
		array('module'=>'Jingpai','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Storenew&a=Jingpai&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Jingpai'],'sub'=>1,'canselected'=>1,'linkurl'=>'','keyword'=>'商城竞拍','askeyword'=>1),
