...
<link type="text/css" rel="stylesheet" href="/css/touch_index.css">
...
<div class="menu">
<a href="<?php echo U('Storenew/cats',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'cid' => $cid, 'twid' => $twid));?>"><i></i>所有商品</a>
<a href="<?php echo U('Storenew/cart',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid));?>"><i></i>购物车</a>
<a href="<?php echo U('Storenew/my',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid));?>"><i></i>查物流</a>
<a href="<?php echo U('Storenew/my',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid));?>"><i></i>用户中心</a>
</div>  
<!--主体-->
...
<!--div class="fixed bottom">
    ...
    <dl class="sub-nav nav-b5">
        ...
        <?php if($allow_distribution == 1): ?><dd>
            <div class="nav-b5-relative"><a href="<?php echo U('DrpStore/add');?>"><i class="icon-nav-store"></i>申请代理</a></div>
        </dd><?php endif; ?>
        <dd>
