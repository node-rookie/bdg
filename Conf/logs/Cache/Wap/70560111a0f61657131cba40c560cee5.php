...
<?php if($banner != ''): ?><img src="<?php echo ($banner); ?>" >
<?php else: ?>
 <img src="tpl/static/messageboard/images/522c649a6fd98.jpg?2013" ><?php endif; ?>
</div>
...
<!--        </form>-->
         ...
         <font id="limsg"></font>
    <?php if($needpass == 1 && session('readMessage') != 1): ?><li class="green bounceInDown"><a href="javascript:showPassInput();">请输入密码查看留言</a></li>
         <script type="text/javascript">
            ...
            function sendpass(){
                ...
                $.ajax({
                    url: '<?php echo U("Reply/checkpass",array("token"=>$_GET["token"]));?>',
                    type: 'POST',
                    dataType: 'html',
                    data: {readpass: pass,token:"<?php echo ($_GET['token']); ?>"},
