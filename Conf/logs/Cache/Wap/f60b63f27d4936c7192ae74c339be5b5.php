    ...
    <div class="wrapper">
        <div id="login-panel" class="panel" data-tab="normal">
            <div id="normal-panel" class="active-panel normal-panel">
                <form id="normal-login-form" action="<?php echo U('Storenew/login',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid,'cid' => $cid));?>" autocomplete="off" method="post">
...
<p class="sub-action"><a href="<?php echo U('Storenew/register', array('token' => $token, 'wecha_id' => $wecha_id, 'twid' => $twid,'cid' => $cid));?>">还没有账号，现在注册</a> <!-- <a href="">找回密码</a> --></p>
