...
<link href="./tpl/static/tpl/1272/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul id="thelist">
		...
		<?php if(is_array($flashbg)): $i = 0; $__LIST__ = $flashbg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li style="background-image:url('<?php echo ($so["img"]); ?>');background-attachment: inherit;background-repeat:no-repeat;background-size:100% 100%;-moz-background-size:100% 100%;-webkit-background-size:100% 100%; background-position: center center " ></li><?php endforeach; endif; else: echo "" ;endif; ?>
