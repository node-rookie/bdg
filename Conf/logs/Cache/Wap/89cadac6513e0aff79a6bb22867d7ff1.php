				...
				<div class="container-content container-rank">
					...
					<table class="table-bottom">
						...
						<col width="80%">
							...
							<td align="left">
								<?php if($myinfo == NULL): ?><a style="color:white" id="myinfo" href="<?php echo U('Userinfo/index',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'redirect'=>'AppleGame/index|id:'.$_GET['id'].',token:'.$_GET['token'].',wecha_id:'.$_GET['wecha_id'].',type:1'));?>">您没有完善资料，请点击这里填写资料</a>
									<script>
...
<br><br>
		...
		<!-- <div class="company-rights">©软灵通版权所有</div>	-->
