...
<?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li>
		...
		<span class="con">
			...
			<span style="color:#c00;font-size:14px;margin-top:15px;">价格：￥<?php echo ($hostlist["price"]); ?></span>
			<span style="color:#999;font-size:12px;margin-top:15px;">销量：<?php echo ($hostlist['salecount'] + $hostlist['fakemembercount']); ?>人付款</span>
			<span class="btn">马上抢购</span>
		</span>
	</li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
<div class="more">
<a id="show_more" page="2" style="display: none;" href="javascript:void(0);">加载更多</a>
</div>
				...
				$.ajax({
					...
					success : function(RES) {
						...
						$.each(data, function(x, y) {
							...
							'<img src="' +y.logourl + '" />' +
							'</a></span><span class="con"><a class="t" href="' + com_link + '&id=' + y.id + '">' + y.name + '</a><b>价格：￥'+ y.price +'&nbsp;元</b><span style="color:#999;font-size:8px;margin-top:15px;">销量：' + (parseInt(y.salecount) + parseInt(y.fakemembercount)) + '人付款</span></span></li>';
						});
