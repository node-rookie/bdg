...
<meta name="format-detection" content="telephone=no">
  <title><?php echo ($imgtxt['title']); ?></title>
<meta name="keywords" content="<?php echo ($imgtxt['keyword']); ?>" />
<meta name="description" content="<?php echo ($imgtxt['text']); ?>" />
   ...
   <!--  <div data-role="panel" id="panel" data-position="right" data-theme="a" data-display="push"></div> -->
    ...
    <div data-role="content" role="main">
      <ul data-role="listview" data-inset="true">
        <li data-role="list-divider" data-theme="a"><?php echo ($imgtxt['title']); ?></li>
        <p style="padding: .7em 1em;vertical-align: middle;"><?php echo (trim(html_entity_decode($imgtxt['info']))); ?></p>
      </ul>
