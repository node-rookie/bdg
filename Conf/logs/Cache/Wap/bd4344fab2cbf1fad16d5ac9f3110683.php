...
<head>
    ...
    <link href="http://static.paipaiimg.com/c/=/fd/qqpai/base/css/gb.min.css,/fd/qqpai/tuan/css/index_v3.min.css?t=1415376382" rel="stylesheet" combofile="qqpai/tuan/index_v2.shtml">
    <style type="text/css">
        body > a {display: none;}
    </style>
</head>
<body>
    ...
    <div style="display: block;" class="rule">
        ...
        <p class="rule_row"><span class="rule_num">(6)</span>拼团，是基于好友的转发扩散，获取团购优惠，为了保证广大消费者的权益，拼好货商城有权将判定为黄牛倒货的团解散并取消订单。</p>
    </div>
</body>
</html>