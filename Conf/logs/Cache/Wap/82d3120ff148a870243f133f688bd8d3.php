...
<html lang="zh-CN">
	<head>
		...
		<script src="<?php echo STATICS;?>/forum/js/pics.js" ></script>
	...
	<body onselectstart="return true;" ondragstart="return false;" class="discuss_comment">
		<div id="container" class="container">
			<header></header>
			<div class="body">
				<form action="<?php echo U('Forum/checkAdd',array('token'=>$token));?>" id="form_1" method="post" enctype="multipart/form-data" >
...
<script>
	...
	function upl(){
		...
		upyunWapPicUpload('portrait'+num,1024,768,'<?php echo ($_GET['token']); ?>');
	}
