...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
	...
	<?php if(ACTION_NAME == 'index'): ?><script type="text/javascript">
			window.shareData = {  
					...
					"timeLineLink": "<?php echo ($f_siteUrl); echo U(Index/ACTION_NAME,array('token'=>$_GET['token']));?>",
					"sendFriendLink": "<?php echo ($f_siteUrl); echo U(Index/ACTION_NAME,array('token'=>$_GET['token']));?>",
					"weiboLink": "<?php echo ($f_siteUrl); echo U(Index/ACTION_NAME,array('token'=>$_GET['token']));?>",
	...
	<?php else: ?>
		<script type="text/javascript">
			window.shareData = {  
				...
				"moduleID": '1',
				"imgUrl": "<?php echo ($homeInfo["picurl"]); ?>", 
				"timeLineLink": "<?php echo ($f_siteUrl); echo U(Index/ACTION_NAME,array('token'=>$_GET['token'],'classid'=>$_GET['classid']));?>",
