...
<li class="tabli" id="tab6"><a href="<?php echo U('Repast/sort', array('token' => $token,'cid' => $cid));?>">分类管理</a></li>
...
<li class="current  tabli" id="tab5"><a href="<?php echo U('Repast/Statistics', array('token' => $token,'cid' => $cid));?>">菜品统计</a></li>
