...
<ul>
	...
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/flash',array('token'=>$token));?>">商城轮播图</a></li>
...
<a href="<?php echo U('Storenew/flashadd', array('token' => $token, 'cid' => $cid, 'type' => 0));?>" title="添加幻灯片" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加幻灯片</a>
</div>
<!--div class="pageNavigator right"> 
<a href="<?php echo U('Storenew/flashadd', array('token' => $token, 'cid' => $cid, 'type' => 1));?>" title="添加幻灯片" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加幻灯片</a>
</div-->
<div class="clr"></div>
</div>
...
<td class="norightborder">
	...
	<a href="<?php echo U('Storenew/flashadd',array('id'=>$vo['id'],'type'=>$vo['type']));?>">编辑</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/flashdel',array('id'=>$vo['id']));?>');">删除</a>
</td>
