    ...
    <div class="msgWrap bgfc" style="margin-top:10px;">
      <form class="form" method="post" action="" target="_top" enctype="multipart/form-data"><table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"><tbody>
                <tr>
                    ...
                    <td> <input type="text" name="keyword" id="keyword"  class="px"  data-rule-maxlength="60" value="<?php echo (($carset['keyword'])?($carset['keyword']):'汽车'); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" name="url" id="url" value="<?php echo ($carset['url']); ?>" class="px"  />
...
<TR>
  ...
  <TD>
    ...
    <input type="text" id="selecttpl" class="px" value="已选择模板 <?php echo (($carset['tpid'])?($carset['tpid']):23); ?>" disabled size="40"  />
    <a class="a_upload" onclick="chooseTpl('tpid','selecttpl',1)">选择模板</a>
    <a class="a_upload" onclick="viewTpl()">预览</a> [请注意,并不是所有模板都支持,如果发现所选模板显示不正确,请另换一个]
    <script>
        function viewTpl(){
            var tid = $('#tpid').val();
            chooseTpl(tid,'',2);
    ...
    <input type="hidden" class="px" id="tpid" value="<?php echo (($carset['tpid'])?($carset['tpid']):23); ?>" name="tpid" style="width:250px">
  </TD>
  <TD>&nbsp;
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <span class="help-block">可以留空</span>
                    </td>
                </tr>
                 <tr>
...
<tr>
                    <th width="120">关于我们:</th>
                    <td>
                         <input type="text" name="title7" id="title7" value="<?php echo (($carset['title7'])?($carset['title7']):'关于我们'); ?>" class="px" />
                         <span class="maroon">* 如 关于我们</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">关于我们图片：</th>
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_7_src" src="<?php echo (($carset['head_url_7'])?($carset['head_url_7']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_7" value="<?php echo (($carset['head_url_7'])?($carset['head_url_7']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_7" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_7',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_7')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
...
<tr>
                    <th width="120">全景看车:</th>
                    <td>
                         <input type="text" name="title8" id="title8" value="<?php echo (($carset['title8'])?($carset['title8']):'全景看车'); ?>" class="px" />
                         <span class="maroon">* 如 全景看车</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">全景看车图片：</th>
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_8_src" src="<?php echo (($carset['head_url_8'])?($carset['head_url_8']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_8" value="<?php echo (($carset['head_url_8'])?($carset['head_url_8']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_8" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_8',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_8')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
				...
				<tr>
                    <th width="120">优惠促销:</th>
                    <td>
                         <input type="text" name="title9" id="title9" value="<?php echo (($carset['title9'])?($carset['title9']):'优惠促销'); ?>" class="px" />
                         <span class="maroon">* 如 优惠促销</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">优惠促销图片：</th>
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_9_src" src="<?php echo (($carset['head_url_9'])?($carset['head_url_9']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_9" value="<?php echo (($carset['head_url_9'])?($carset['head_url_9']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_9" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_9',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_9')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
...
<tr>
                    <th width="120">咨询动态:</th>
                    <td>
                         <input type="text" name="title10" id="title10" value="<?php echo (($carset['title10'])?($carset['title10']):'咨询动态'); ?>" class="px" />
                         <span class="maroon">* 如 咨询动态</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">咨询动态图片：</th>
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_10_src" src="<?php echo (($carset['head_url_10'])?($carset['head_url_10']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_10" value="<?php echo (($carset['head_url_10'])?($carset['head_url_10']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_10" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_10',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_10')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
...
<tr>
                    <th width="120">尊选二手车:</th>
                    <td>
                         <input type="text" name="title11" id="title11" value="<?php echo (($carset['title11'])?($carset['title11']):'尊选二手车'); ?>" class="px" />
                         <span class="maroon">* 如 尊选二手车</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">尊选二手车图片：</th>
                    <td>
                     <p>
                         <img class="thumb_img" id="head_url_11_src" src="<?php echo (($carset['head_url_11'])?($carset['head_url_11']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="head_url_11" value="<?php echo (($carset['head_url_11'])?($carset['head_url_11']):'tpl/User/default/common/car/lanbo14.jpg'); ?>" name="head_url_11" >

                         <span class="help-inline">
                              <a href="###" onclick="upyunPicUpload('head_url_11',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('head_url_11')">预览</a>
                              <span class="help-inline">建议图片尺寸365*158，图片大小不超过100K</span>
                         </span>
                     </p>
                    </td>
                  ...
                  <tr>
                    <td>
                    <?php if($carset['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($carset['id']); ?>" />
                    <input type="hidden" name="status" value="editstatus" /><?php endif; ?>
