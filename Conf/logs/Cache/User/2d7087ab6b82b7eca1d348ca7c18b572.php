...
<li <?php if($tab == 'wifi'): ?>class="selectTag"<?php endif; ?>>
				<a href="<?php echo U('Hardware/wifi');?>">微信wifi</a> 
			</li>
...
<TR>
  ...
  <TD><input type="input" class="px" id="mp"  name="mp" style="width:200px"  value="<?php echo ($info["mp"]); ?>" >    </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="acttitle">终端号：</label></TH>
  <TD><input type="input" class="px" id="mcode"  name="mcode" style="width:500px"  value="<?php echo ($info["mcode"]); ?>" >  打印机底部查看 </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="acttitle">密钥：</label></TH>
  <TD><input type="input" class="px" id="mkey"  name="mkey" style="width:500px"  value="<?php echo ($info["mkey"]); ?>" >  打印机底部查看 </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="acttitle">打印份数：</label></TH>
  <TD><input type="input" class="px" id="count"  name="count" style="width:100px"  value="<?php echo ($info["count"]); ?>" >  每个订单打印几份 </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  ...
  <TD><select name="companyid" class="pt">
  	...
  	</select> 用于哪个店面&nbsp;&nbsp;<a href="/index.php?g=User&m=Company&a=index&token=<?php echo ($token); ?>">点击这里添加店面</a>   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
