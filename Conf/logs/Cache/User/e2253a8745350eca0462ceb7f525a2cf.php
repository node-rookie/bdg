...
<div class="tab">
<ul>
	<li class="current tabli" id="tab8"><a href="<?php echo U('Storenew/grouponproduct',array('token'=>$token,'cid' => $cid));?>">团购商品</a></li>
...
<td>销售价：<?php echo ($hostlist["price"]); ?> 元<br>团购价：<?php echo ($hostlist["tgprice"]); ?> 元</td>
