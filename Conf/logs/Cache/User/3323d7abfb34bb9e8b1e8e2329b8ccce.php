...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Repast/dishadd',array('token' => $token,'cid'=>$cid));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加菜品</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Repast/refreshStock',array('token' => $token,'cid'=>$cid));?>" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">刷新菜品库存</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
