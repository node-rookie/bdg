...
<tr>
  ...
  <td><input type="text" class="px" id="url" value="<?php echo ($info["url"]); ?>" name="url" style="width:300px"> <a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><a href="<?php echo U('Live/highLive',array('token'=>$token));?>" target="_blank" class="a_choose">创建新场景</a><br>
  </td>
  <td>&nbsp;</td>
</tr>
<TR>
