...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
        <div class="content">
<div class="cLineB">
<h4 class="left">在线支付对账订单管理（<a href="<?php echo U('Storenew/grouponorders',array('token'=>$token,'handled'=>0));?>">未处理订单<span style="color:#f00"><?php echo ($unhandledCount); ?></span>个</a>） (<?php echo ($page); ?>) </h4>
...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Storenew/orders',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btnGreen" style="margin-top:-27px">返回上</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
...
<div class="tab">
<ul>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/grouponproduct',array('token'=>$token,'cid' => $cid));?>">团购商品</a></li>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/groupon',array('token'=>$token,'cid' => $cid));?>">团购管理</a></li>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/grouponorders',array('token'=>$token,'cid'=>$cid));?>">团购订单</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/groupontuikuan',array('token'=>$token,'cid'=>$cid));?>">团购退款</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
...
<a href="<?php echo U('Storenew/grouponorders', array('token' => $token, 'cid' => $cid,'sent'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已发货</a>
<a href="<?php echo U('Storenew/grouponorders', array('token' => $token, 'cid' => $cid,'sent'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未发货</a>
<a href="<?php echo U('Storenew/grouponorders', array('token' => $token, 'cid' => $cid,'paid'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已付款</a>
<a href="<?php echo U('Storenew/grouponorders', array('token' => $token, 'cid' => $cid,'paid'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未付款</a>
</div>
<div class="pageNavigator right"> 
<a href="<?php echo U('Storenew/orders', array('token' => $token, 'cid' => $cid));?>" title="商城设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">订单管理</a>
<div class="clr"></div>
</div>
<div class="clr"></div>
</div>
...
function showIntroDetail(id){
	art.dialog.open('<?php echo U('Storenew/grouponordersInfo',array('token'=>$token,'dining'=>$isDining));?>&id='+id,{lock:false,title:'订单详情',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87, close: function(){location.reload();}});
}
</script>
</div>
<div class="cLine">
