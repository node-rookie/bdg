...
.dtas p{line-height:30px;}
 ...
 <div style="line-height: 32px;margin:10px 0">
 <a href="<?php echo U('Hardware/orderprintSet');?>" class="btnGrayS vm bigbtn" >添加打印机</a>　 
</div>

<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
<thead>
<tr>
<th style=" width:100px;">绑定手机号</th>
<th style=" width:100px;">终端号</th>
<th style=" width:100px;">密钥</th>              
...
<a href="<?php echo U('Hardware/orderprintSet',array('id'=>$actinfo['id'],'token'=>$_SESSION['token']));?>" >修改</a>&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Hardware/orderprintDelete',array('token'=>$token,'id'=>$actinfo['id']));?>');">删除</a>
