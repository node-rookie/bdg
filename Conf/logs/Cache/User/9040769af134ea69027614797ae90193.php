...
<div class="pageNavigator right"> <a href="<?php echo U('Hotels/batchadd',array('token' => $token,'cid'=>$cid));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">批量添加房间</a></div>
...
<tbody>
<tr></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i;?><tr id="tr_<?php echo ($tablelist['id']); ?>">
		<td><input type="checkbox" name="del_id[]" value="<?php echo ($tablelist['id']); ?>" class="checkitem" /></td>
...
$(document).ready(function(){
	...
	$("#batchdelete").click(function(){
		...
		$.post("<?php echo U('Hotels/batchdelete',array('token' => $token,'cid' => $cid));?>", {'ids':ids}, function(data){
