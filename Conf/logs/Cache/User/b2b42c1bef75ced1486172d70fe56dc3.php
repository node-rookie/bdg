...
<div class="content">
<div class="cLineB">
<h4 class="left">团购商品管理(<?php echo ($page); ?>)</h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
<ul>
	...
	<li class="current tabli" id="tab8"><a href="<?php echo U('Storenew/groupon',array('token'=>$token,'cid' => $cid));?>">团购管理</a></li>
...
<a href="<?php echo U('Storenew/addnew', array('token' => $token, 'cid' => $cid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">查看团购商品</a>
</div>
<div class="pageNavigator right">
	<a href="<?php echo U('Storenew/grouponorders',array('token'=>$token,'cid'=>$cid));?>" class="btnGrayS vm bigbtn">查看团购订单</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<th width="180">付款时间</th>
<th width="120" class="norightborder">操作</th>
</tr>
</thead>
<tbody>
<tr></tr>
<?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($hostlist["id"]); ?></td>
...
<td><?php if($hostlist["paid"] == '1'): ?><font color="red">已付款</font><?php endif; ?></td>
<td>创建时间:<?php echo (date("Y-m-d H:i:s",$hostlist["addtime"])); ?><br>结束时间:<?php echo (date("Y-m-d H:i:s",$hostlist["endtime"])); ?></td> 
<td class="norightborder" align="center">
	<a href="###" onclick="showIntroDetail(<?php echo ($hostlist["cartid"]); ?>)">详细</a>
</td>
