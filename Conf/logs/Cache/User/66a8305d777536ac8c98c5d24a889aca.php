...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
  <div class="cLineB">
	<h4 class="left">分佣设置</h4>
	<div class="clr"></div>
  </div>
<!--tab start-->
<div class="tab">
<ul>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/twitterset', array('token' => $token, 'cid' => $cid));?>">分佣设置</a></li>
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
	   ...
	   <tr>
        <th>二级代销佣金：</th>
        <td><input type="text" name="addpercent" value="<?php echo ($set['addpercent']); ?>" class="px" style="width:100px;" />%（只要填写数据，不要填写%。如商品总价1000，百分比0.1，那么推广号获得的分佣 = 1000 * 0.1% = 1元）</td> 
       </tr>

       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Storenew/twitter',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
