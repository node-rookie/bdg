...
<div class="content">
	...
	<div class="tab">
		<ul>
			<li class="tabli" id="tab1"><a href="<?php echo U('Bargain/index',array('token'=>$token));?>">砍价商品</a></li>
			<li class="current tabli" id="tab2"><a href="<?php echo U('Bargain/order',array('token'=>$token));?>">订单管理</a></li>
		</ul>
	</div>
...
<script>
	...
	function seach(){
		...
		if(orderid != ""){
			window.location.href="<?php echo U('Bargain/order',array('token'=>$token));?>&orderid="+orderid;
		}else{
			window.location.href="<?php echo U('Bargain/order',array('token'=>$token));?>";
		}
	}
</script>
</div>
