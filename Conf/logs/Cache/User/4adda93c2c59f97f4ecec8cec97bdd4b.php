...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        <div class="content">
          <div class="cLineB">
              <h4 class="left">幸运九宫格活动信息 (<?php echo ($count); ?>) 条<span class="FAQ">你本月有 <?php echo ($group["activitynum"]); ?> 次机会可免收活动创建费，已经使用了 <?php echo ($activitynum); ?> 次机会!</span></h4>
                  <div class="searchbar right">
				  <form method="post"  action=""  >
                  <input type="text" id="msgSearchInput" class="txt left" placeholder="输入关键词搜索"  name="keyz" value="<?php echo ($_POST['keyz']); ?>">
          ...
          <div class="cLine">
			...
			<a href='/index.php?g=User&m=Jiugong&a=add' title='新增幸运九宫格活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-lottery.png" class="vm" />新增幸运九宫格活动</a>
              ...
              <TBODY>
                <TR></TR>
				  ...
				  <?php if($list['status'] == 0): ?><span class="red">未开始</span><?php elseif($list['status'] == 2): ?><span class="red">已经结束</span><?php else: ?><span class="green">已经开始</span><?php endif; ?>
				   ...
				   <a href="index.php?g=User&m=Jiugong&a=sn&id=<?php echo ($list["id"]); ?>">SN码管理</a> 
				   <a href="index.php?g=User&m=Jiugong&a=cheat&id=<?php echo ($list["id"]); ?>">作弊</a>
				   <a href="index.php?g=User&m=Jiugong&a=edit&id=<?php echo ($list["id"]); ?>">编辑</a>  
				   <a href="
				   <?php if($list['status'] == 1): ?>javascript:drop_confirm('你确定要结束活动吗，结束后不可再开启本活动!', 'index.php?g=User&m=Jiugong&a=endLottery&id=<?php echo ($list["id"]); ?>');
				   <?php else: ?>
				   index.php?g=User&m=Jiugong&a=startLottery&id=<?php echo ($list["id"]); endif; ?>">
				   <?php if($list['status'] == 0): ?>开始<?php else: ?>结束<?php endif; ?>				   
				   </a>
				  
				   <a href="index.php?g=User&m=Jiugong&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
