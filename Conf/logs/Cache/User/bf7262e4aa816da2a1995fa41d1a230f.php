...
<div class="content">
	...
	<div class="cLine">
		<div class="pageNavigator left">
			<a href="<?php echo U('Member_card/donate_set', array('token' => $token,'cardid'=>$cardid));?>" title="添加赠送" class="btnGrayS vm bigbtn"><img class="vm" src="./tpl/User/default/common/images/product/add.png">添加赠送</a>
		</div>
		<div class="clr"></div>
	</div>
		...
		<div class="msgWrap form">
			 <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($list["min_price"]); ?></td>
						<td><?php echo ($list["max_price"]); ?></td>
						<td><?php echo ($list["donate_price"]); ?></td>
						<td>
							<?php if($list["is_open"] == 1): ?><font color="#44b549">开启</font>
							<?php else: ?>
								<font color="#f00">关闭</font><?php endif; ?>
						</td>
						<td>
							<a href="<?php echo U('Member_card/donate_set', array('token' => $token,'id'=>$list['id'],'cardid'=>$cardid));?>">修改</a> 
							|
							<a href="<?php echo U('Member_card/donate_del', array('token' => $token,'id'=>$list['id'],'cardid'=>$cardid));?>">删除</a>
						</td>
