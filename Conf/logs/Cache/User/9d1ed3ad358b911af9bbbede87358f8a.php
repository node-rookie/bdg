...
<?php $__FOR_START_3059__=1;$__FOR_END_3059__=12;for($i=$__FOR_START_3059__;$i < $__FOR_END_3059__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择设备：
...
<?php $__FOR_START_21777__=1;$__FOR_END_21777__=12;for($i=$__FOR_START_21777__;$i < $__FOR_END_21777__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择页面：
