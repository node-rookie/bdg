...
<div class="content">
<div class="cLineB">
<h4 class="left">新闻管理(<?php echo ($page); ?>)</h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
<ul>
	...
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/set_reply',array('token'=>$token));?>">新版商城回复设置</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/flash',array('token'=>$token));?>">商城背景与轮播图</a></li>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/twitter',array('token'=>$token));?>">商城分佣管理</a></li>
	<li class="current tabli" id="tab8"><a href="<?php echo U('Storenew/news',array('token'=>$token,'cid' => $cid));?>">新闻管理</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left">
<a href="<?php echo U('Storenew/newsset', array('token' => $token, 'cid' => $cid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加新闻</a>
</div>
<div class="pageNavigator right">
	<a href="<?php echo U('Storenew/news',array('token'=>$token,'cid'=>$cid));?>" class="btnGrayS vm bigbtn">查看新闻</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($news["title"]); if($news["status"] == '1'): ?><br><font color="red">[已隐藏]</font><?php endif; ?></td>
<td><?php echo (date("Y-m-d H:i:s",$news["add_time"])); ?></td> 
<td class="norightborder" align="center">
	<a href="<?php echo U('Storenew/newsset',array('id' => $news['id'], 'token' => $token,'cid' => $cid));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/delnews',array('id'=>$news['id'],'token'=>$token,'cid'=>$cid));?>');">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
</td>
