     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       ...
       <tr> 
        ...
        <th>是否外卖：</th> 
        <td>
        <input type="checkbox" name="istakeout" id="istakeout" value="1" <?php if($tableData['istakeout'] == 1): ?>checked<?php endif; ?> />
        ...
        <th>是否支持会员折扣：</th> 
        <td>
        <input type="checkbox" name="isdiscount" id="isdiscount" value="1" <?php if($tableData['isdiscount'] == 1): ?>checked<?php endif; ?> />
        ...
        <th>在售库存值：</th> 
        <td>
        <input type="text" name="instock" id="instock" class="px" value="<?php echo ($tableData["instock"]); ?>"/>
        ...
        <th>刷新库存值：</th> 
        <td>
        <input type="text" name="refreshstock" id="refreshstock" class="px" value="<?php echo ($tableData["refreshstock"]); ?>" />
       ...
       <tr> 
        <th>描述：</th> 
        <td><textarea name="des" class="px" style="width:400px;height:80px;"><?php echo ($tableData["des"]); ?></textarea>
       ...
       <th>&nbsp;</th>
       <td>
       <a type="submit" name="submit" class="btnGreen" id="toSaveThis">保 存</a> &nbsp; <a href="<?php echo U('Repast/dish',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
