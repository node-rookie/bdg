...
<div class="cLineB">
  <h4>奖品设置</h4>
  <a href="javascript:window.history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  <TH valign="top"><span class="red">*</span><label for="acttitle">奖项名称：</label></TH>
  <TD><input type="input" class="px" id="title"  name="name" style="width:400px"  value="<?php echo ($info["name"]); ?>" >    </TD>
</TR>
<TR>
  <TH valign="top"><span class="red">*</span><label for="acttitle">奖品名称：</label></TH>
  <TD><input type="input" class="px" id="title"  name="pname" style="width:400px"  value="<?php echo ($info["pname"]); ?>" >    </TD>
</TR>
<TR>
  <TH valign="top"><span class="red">*</span><label for="acttitle">奖品数量：</label></TH>
  <TD><input type="input" class="px" id="keyword"  name="num" style="width:400px"  value="<?php echo ($info["num"]); ?>" >    </TD>
</TR>

<TR>
  <TH valign="top"><span class="red">*</span><label for="text">奖品图片：</label></TH>
  <TD>
    <input type="input" class="px" id="pic" value="<?php echo ($info["pic"]); ?>" name="pic" style="width:300px">  
    <a href="###" onclick="upyunPicUpload('pic',400,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
    <a href="###" onclick="viewImg('logo')" class="a_upload">预览</a>[400*400]
  </TD>
</TR>
<TR>
  <TH valign="top"><label for="text">顺序：</label></TH>
  <TD><input type="input" class="px" id="sort" value="<?php if($info["sort"] > 0): echo ($info["sort"]); else: ?>50<?php endif; ?>" name="sort" >  </TD>
</TR>
<TR>
  <TH></TH>
  <TD>
