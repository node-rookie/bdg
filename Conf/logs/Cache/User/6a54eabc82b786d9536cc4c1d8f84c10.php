...
'insertunorderedlist', '|', 'emoticons', 'image','link', 'unlink','baidumap','lineheight','table','anchor','preview','print','template','code','cut']
  ...
  <div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>> 
   <div class="cLineB"> 
    <h4>添加回复</h4> 
    <a href="<?php echo U('Reply/index',array('token'=>$token,'wecha_id'=>$wecha_id));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
   

   <form class="form" method="post" id="form" action="<?php echo U('User/Reply/insert',array('token'=>$token,'wecha_id'=>$wecha_id));?>"> 
...
<input type="hidden" name="chk"  value="<?php echo ($chk_value); ?>" />
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
        ...
        <TR>
                  ...
                  <TD><textarea name="content" id="content"  rows="5" style="width:590px;height:360px"></textarea></TD>
                </TR>  
       <tr>         
       <th>&nbsp;</th>
       <td>
      <input type="hidden" name="groupon" value="1" />
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Reply/index',array('token'=>$token,'wecha_id'=>$wecha_id));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
