...
<div class="tab">
<ul>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/twitterset', array('token' => $token, 'cid' => $cid));?>">分佣设置</a></li>
	<li class="tabli" id="tab0"><a href="<?php echo U('Storenew/removesearch', array('token' => $token, 'cid' => $cid));?>">查看申请提现</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/detailinfo',array('token'=>$token));?>">查看分佣信息</a></li>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/twitter',array('token'=>$token));?>">商城分佣管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/twitterlist',array('token'=>$token));?>">分销员管理</a></li>
...
<!--div class="cLine">
	<div class="pageNavigator left"> 
		<a href="<?php echo U('Storenew/twitterset', array('token' => $token, 'cid' => $cid));?>" title="分佣设置" class="btnGrayS vm bigbtn">
			<img src="<?php echo RES;?>/images/product/add.png" class="vm" />分佣设置
		</a>
	</div>
	<div class="pageNavigator right"> 
		<a href="<?php echo U('Storenew/removesearch', array('token' => $token, 'cid' => $cid));?>" title="查看申请提现" class="btnGrayS vm bigbtn">
			<img src="<?php echo RES;?>/images/product/add.png" class="vm" />查看申请提现
		</a>
	</div>
	<div class="clr"></div>
</div-->
...
<tr>
<th width="150">推广人</th>
<th width="150">分佣会员</th>
<th width="150">推广订单</th>
<th width="150">分佣总金额</th>
<th width="150">已提现的金额</th>
...
<td><?php echo ($hostlist['truename']); ?><br/><?php echo ($hostlist['twid']); ?></td>
<td>推广会员：<?php echo ($hostlist['allcount']); ?><br/>一级会员：<?php echo ($hostlist['fromcount']); ?><br/>二级会员：<?php echo ($hostlist['addcount']); ?></td>
<td><?php echo ($hostlist['ordercount']); ?></td> 
<td><?php echo ($hostlist['total']); ?></td> 
<td><?php echo ($hostlist['remove']); ?></td> 
<td class="norightborder">
	<a href="<?php echo U('Storenew/detail',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">佣金获取详情</a>
	<span>&nbsp;&nbsp;　|　&nbsp;&nbsp;<a href="<?php echo U('Storenew/remove',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">提现详情</a></span>
</td>
