...
<script src="<?php echo ($staticPath); ?>/tpl/static/js/date/WdatePicker.js" type="text/javascript"></script>
<div class="content">
<div class="cLineB" style="line-height: 20px;">
<a href="<?php echo U('Voteimg/banner_manage',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">banner管理</a> <a href="<?php echo U('Voteimg/stat_list',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">统计栏管理</a> <a href="<?php echo U('Voteimg/menu_list',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">菜单管理</a> <a href="<?php echo U('Voteimg/bottom_list',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">底部管理</a>
<a href="<?php echo U('Voteimg/apply_list',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">报名管理</a>
<a href="<?php echo U('Voteimg/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:1px">返回投票列表</a>
</div>
  <h2> 
    图文投票-banner管理
</h2>(建议图片分辨率1080*450)
<div class="msgWrap bgfc">
<form class="form" method="post" action="<?php echo U('Voteimg/banner_manage',array('id'=>$action_id,'token'=>$token));?>" target="_top" enctype="multipart/form-data">
<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
<tbody>
<?php if($banner_list != ''): if(is_array($banner_list)): $i = 0; $__LIST__ = $banner_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$banner): $mod = ($i % 2 );++$i;?><tr>
<th width="55" style="width:55px;">banner图片：</th>
<td width="200">
<input type="hidden" name="add[id][]" value="<?php echo ($banner["id"]); ?>" style="width:20px;" >
  <input type="text" style="width:350px;" id="img_<?php echo ($banner["id"]); ?>" class="px" value="<?php echo ($banner["img_url"]); ?>" name="add[img_url][]">
  <a class="a_upload" onclick="upyunPicUpload('img_<?php echo ($banner["id"]); ?>',700,400,'<?php echo ($token); ?>')" href="javascript:;">上传</a>
  <a onclick="viewImg('img_<?php echo ($banner["id"]); ?>')" href="###">预览</a>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="add[external_links][]" value="<?php echo ($banner["external_links"]); ?>" class="px" style="width:150px;">跳转链接&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="add[banner_rank][]" value="<?php echo ($banner["banner_rank"]); ?>" class="px" style="width:20px;"/>排序
	&nbsp;&nbsp;&nbsp;&nbsp;<a class="del" vid="0" href="<?php echo U('Voteimg/del_banner',array('vote_id'=>$banner['vote_id'],'token'=>$banner['token'],'id'=>$banner['id']));?>">删除</a>
</td>
...
<input type="hidden" name="add[id][]" value="0" style="width:20px;" >
  ...
  <a class="a_upload" onclick="upyunPicUpload('img_1',700,400,'<?php echo ($token); ?>')" href="javascript:;">上传</a>
...
$(function(){
	$("#addItem").click(function(){
		...
		var str = '<tbody><tr><th width="4" style="width:4px">banner图片：</th><td width="200"><input type="hidden" name="add[id][]" value="0" style="width:20px;" ><input type="text" style="width:350px;" id="url_'+len+'" class="px" value="" name="add[img_url][]"><a class="a_upload" onclick="upyunPicUpload(\'url_'+len+'\',700,400,\'<?php echo ($token); ?>\')" href="javascript:;">上传</a><a onclick="viewImg(\'url_'+len+'\')" href="###">&nbsp;&nbsp;预览</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="add[external_links][]" value="" class="px" style="width:150px;">跳转链接&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="add[banner_rank][]" value="" class="px" style="width:20px;"/>排序&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="del" vid="0" href="javascript:;">删除</a></td></tr></tbody>';
