...
<div class="content"> 
	...
	<div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">此处只显示总店信息，连锁店订单及菜品请进入相应平台进行管理，连锁店登录账号密码及登录地址请在LBS里设置查看<br/>
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       <tr> 
        <th>营业时间：</th> 
		<td style="width:480px">从 <input type="input" class="px" name="zc_sdate" id="zc_sdate" value="<?php if($mtime['zc_sdate'] > 0): echo (date("H:i",$mtime['zc_sdate'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 开始
		到
		<input type="input" class="px" name="zc_edate" id="zc_edate" value="<?php if($mtime['zc_edate'] > 0): echo (date("H:i",$mtime['zc_edate'])); endif; ?>"  onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 结束</td>
		<td rowspan="2"><span class="red">营业时间的结束时间不可大于营业时间的开始时间。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;营业时间未设置 将默认为全天24小时营业送餐。</span></td>
       </tr>
	   <!---
       <tr> 
        <th>晚餐送餐时间段：</th> 
