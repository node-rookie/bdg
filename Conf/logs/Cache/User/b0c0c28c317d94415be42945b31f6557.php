...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Crowdfunding/basis_set',array('token'=>$token));?>" title="添加众筹" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加众筹</a></div>
