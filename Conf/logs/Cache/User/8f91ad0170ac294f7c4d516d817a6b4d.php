...
<div class="cLine">
<div class="pageNavigator left"><a href="<?php echo U('Hongbao/action_add',array('token'=>$token));?>" title="添加活动" class="btnGrayS vm bigbtn">添加活动</a> </div>
