...
<div class="tab">
<ul>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/index',array('token'=>$token));?>">商品分类管理</a></li>
	<li class="tabli" id="tab0"><a href="<?php echo U('Storenew/product',array('token'=>$token, 'cid'=>$cid));?>">商品管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/orders',array('token'=>$token));?>">订单管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/set_reply',array('token'=>$token));?>">商城回复设置</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/flash',array('token'=>$token));?>">商城轮播图</a></li>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/jingpai',array('token'=>$token,'cid' => $cid));?>">竞拍管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/lockuser',array('token'=>$token));?>">商城黑名单管理</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> 
<a href="<?php echo U('Storenew/catAdd', array('token' => $token, 'cid' => $cid, 'parentid' => $parentid));?>" title="新增分类" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增分类</a>
</div>
<?php if($parentid > 0): ?><div class="pageNavigator right">
<a href="<?php echo U('Storenew/index',array('token'=>$token, 'cid' => $cid, 'parentid' => $parentCat['parentid']));?>" class="btnGrayS vm bigbtn">返回上级分类</a>
</div>
<?php else: ?>
<div class="pageNavigator right"> 
<a href="<?php echo U('Storenew/setting', array('token' => $token, 'cid' => $cid));?>" title="商城设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">商城设置</a>
</div><?php endif; ?>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($hostlist["norms"]); if(empty($hostlist['norms']) != true): ?><span>&nbsp;&nbsp;<a href="<?php echo U('Storenew/norms', array('catid'=>$hostlist['id'],'token'=>$token, 'type' => 0));?>">规格的管理</a></span><?php endif; ?></td> 
<td><?php echo ($hostlist["color"]); if(empty($hostlist['color']) != true): ?><span>&nbsp;&nbsp;<a href="<?php echo U('Storenew/norms', array('catid'=>$hostlist['id'],'token'=>$token, 'type' => 1));?>">外观的管理</a></span><?php endif; ?></td> 
<td><?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?></td> 
<td class="norightborder">
	<a href="<?php echo U('Storenew/catSet',array('token' => $token, 'id' => $hostlist['id'], 'cid' => $cid));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/catDel',array('id'=>$hostlist['id'],'token'=>$token, 'cid' => $cid));?>');">删除</a>
	<!-- <span>&nbsp;|&nbsp;<a href="<?php echo U('Storenew/norms', array('catid'=>$hostlist['id'],'token'=>$token));?>">增加规格</a></span> -->
	<span>&nbsp;|&nbsp;<a href="<?php echo U('Storenew/attributes',array('catid'=>$hostlist['id'],'token'=>$token));?>">分类属性管理</a></span>
	<?php if($hostlist['isfinal'] != 1): ?><span>&nbsp;|&nbsp;<a href="<?php echo U('Storenew/index',array('parentid' => $hostlist['id'],'level' => $hostlist['level'],'token'=>$token));?>" style="color:#f00">子分类列表</a></span><?php endif; ?>
	<?php if($hostlist['isfinal'] != 2): ?><span>&nbsp;|&nbsp;<a href="<?php echo U('Storenew/product',array('catid' => $hostlist['id'],'token'=>$token));?>" style="color:#f00">商品管理</a></span><?php endif; ?>
</td>
