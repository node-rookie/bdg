...
<a href="<?php echo U('Voteimg/bottom_add',array('token'=>$token,'vote_id'=>$vote_id));?>" title="添加活动" class="right btnGrayS vm">添加底部导航</a>
<a href="<?php echo U('Voteimg/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:1px">返回投票列表</a>
  ...
  <h2> 
	...
	<thead>
	<tr>
	  <th style="width:10%;">导航名称</th>
	  <th style="width:25%;">导航链接</th>
	  <th style="width:35%;">导航icon</th>
	  <th style="width:8%;">导航排序</th>
	  <th style="width:8%;">是否隐藏</th>
	</th>
	<th>操作</th>
	</tr>
	</thead>
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  <td><?php echo ($vo["bottom_name"]); ?></td>
		  <td><?php if($vo["type"] == 2): ?>---<?php else: echo ($vo["bottom_link"]); endif; ?></td>
		  <td><?php echo ($vo["bottom_icon"]); ?> </td>
		  <td><?php if($vo["type"] == 2): ?>---<?php else: echo ($vo["bottom_rank"]); endif; ?></td>
		  <td><?php if($vo["hide"] == 1): ?>否<?php else: ?>是<?php endif; ?></td>
		  <td class="norightborder">
		  <a href="<?php echo U('Voteimg/bottom_add',array('id'=>$vo['id'],'vote_id'=>$vote_id,'token'=>$vo['token']));?>" class="btnGreen">编辑</a>  <?php if($vo["type"] == 1): ?><a href="<?php echo U('Voteimg/bottom_del',array('bottom_id'=>$vo['id']));?>" class="btnGreen">删除</a><?php endif; ?>
		  </td>
		</tr>
