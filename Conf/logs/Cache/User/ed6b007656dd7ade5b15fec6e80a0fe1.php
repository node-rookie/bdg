...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
        <div class="content">
<div class="cLineB">
<h4 class="left">竞拍订单管理（<a href="<?php echo U('Storenew/jingpaiorders',array('token'=>$token,'handled'=>0));?>">未处理订单<span style="color:#f00"><?php echo ($unhandledCount); ?></span>个</a>） (<?php echo ($page); ?>) </h4>
...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Storenew/jingpai',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btnGreen" style="margin-top:-27px">返回上</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
...
<div class="tab">
<ul>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/orders',array('token'=>$token));?>">商城订单</a></li>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/jingpaiorders',array('token'=>$token));?>">竞拍订单</a></li>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/grouponorders',array('token'=>$token,'cid' => $cid));?>">团购订单</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/onlineorders',array('token'=>$token));?>">线上支付对账</a></li>
	<li class="tabli" id="tab8"><a href="<?php echo U('Storenew/cardpayorders',array('token'=>$token,'cid' => $cid));?>">会员卡付款对账</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
...
<a href="###" onclick="$('#info').submit()" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">处理订单</a>
<a href="<?php echo U('Storenew/jingpaiorders', array('token' => $token, 'cid' => $cid,'paid'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已付款订单</a>
<a href="<?php echo U('Storenew/jingpaiorders', array('token' => $token, 'cid' => $cid,'paid'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未付款订单</a>
<a href="<?php echo U('Storenew/jingpaiorders', array('token' => $token, 'cid' => $cid,'sent'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已发货订单</a>
<a href="<?php echo U('Storenew/jingpaiorders', array('token' => $token, 'cid' => $cid,'sent'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未发货订单</a>
</div>
<div class="pageNavigator right"> 
<a href="<?php echo U('Storenew/jingpai', array('token' => $token, 'cid' => $cid));?>" title="商城设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">竞拍管理</a>
<div class="clr"></div>
</div>
<div class="clr"></div>
</div>
...
<td><?php if($o["truename"] == ''): ?><font color=#999>昵称: <?php echo ($o["name"]); ?></font><?php else: ?>收货人: <?php echo ($o["truename"]); endif; ?> <?php if($isDining == 1): ?><span style="color:#f60">[<?php if($o["diningtype"] == 1): ?>点餐<?php elseif($o["diningtype"] == 2): ?>外卖<?php elseif($o["diningtype"] == 3): ?>预定<?php else: endif; ?>]</span><?php endif; ?></td>
<td><?php echo ($o["tel"]); ?></td>
<td><?php echo ($o["total"]); ?></td>
<td><?php echo ($o["price"]); ?> 元</td>
<td>
<?php if($o["paid"] == 1): ?><span style="">已付款</span><?php else: ?><span style="color:red">未付款</span><?php endif; ?> / <?php if($o["sent"] == 1): ?><span style="">已发货</span><?php else: ?><span style="color:red">未发货</span><?php endif; ?>
<?php if($o["sent"] == 1): ?><br><br><span style="color:red"><?php echo ($o["wuliustat"]); ?></span>  <a href="http://www.kuaidi100.com/chaxun?com=<?php echo ($o["logistics"]); ?>&nu=<?php echo ($o["logisticsid"]); ?>" target="_blank">查看详情</a><?php endif; ?>
</td>
<td><?php if($o["handled"] == 1): ?><span style="color:green">已处理</span><?php else: ?><span style="color:red">未处理</span><?php endif; ?></td>
<td>
	<?php if($o['paid'] == '1'): if($o['paytype'] == 'alipay'): ?><span style="color:green">支付宝</span>
		...
		<?php elseif($o['paytype'] == 'CardPay'): ?><span style="color:green">会员卡支付</span>
		<?php elseif($o['paytype'] == 'chinabank'): ?><span style="color:green">网银在线</span><?php endif; ?>
	<?php else: endif; ?>
</td>
<td><?php echo (date("Y-m-d H:i:s",$o["time"])); ?></td>
<td><?php echo ($o["orderid"]); ?></td> 
<td class="norightborder"><a href="###" onclick="showIntroDetail(<?php echo ($o["id"]); ?>)">详细</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/deleteOrder',array('token'=>$token,'id'=>$o['id'],'dining'=>$isDining));?>');">删除</a></td>
...
function showIntroDetail(id){
	art.dialog.open('<?php echo U('Storenew/jingpaiorderInfo',array('token'=>$token,'dining'=>$isDining));?>&id='+id,{lock:false,title:'订单详情',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87, close: function(){location.reload();}});
}
</script>
</div>
<div class="cLine">
