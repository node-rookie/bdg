        ...
        <div class="sideBar">
          <div class="catalogList">
            <ul class="<?php if($usertplid != 0): ?>newskin<?php endif; ?>">
				...
				<li class=" subCatalogList "> <a class="secnav_5" href="<?php echo U('Alipay/vip');?>">升级</a> </li>
...
<div class="clr"></div>
    ...
    <?php }?>
      ...
      <?php if($vo["type"] == 1 and $oauthUrl != ''): if($vo["authorizer_refresh_token"] == ''): ?><a href="<?php echo ($oauthUrl); ?>%26ac_id%3D<?php echo ($vo["id"]); ?>" class="btnGreens">重新授权</a><?php endif; ?>
      <?php elseif($vo["type"] == 0 and $oauthUrl != '' and $vo["fuwuappid"] != ''): ?>
        <a href="<?php echo ($oauthUrl); ?>%26ac_id%3D<?php echo ($vo["id"]); ?>" class="btnGreens">登陆授权</a><?php endif; endif; ?>
