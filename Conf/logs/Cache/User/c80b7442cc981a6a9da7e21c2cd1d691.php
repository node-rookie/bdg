				...
				<tr>
					...
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="weixin[open]" id="open_weixin_yes" value="1" <?php if($config['weixin']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="weixin[open]" id="open_weixin_no" value="0" <?php if($config['weixin']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="hidden" id="weixin_setting">
								<div class="setting_rows">
									...
									<?php if ($wxuser['appid']&&$wxuser['appsecret']){ ?>
										
										<p style="display:none"><span>Appid：</span><input type="text" name="weixin[new_appid]" value="<?php echo ($wxuser["appid"]); ?>" class="px"/>&nbsp;&nbsp;公众账号ID</p>
										...
										<p style="display:none"><span>Appsecret：</span><input type="text" name="weixin[appsecret]" value="<?php echo ($wxuser["appsecret"]); ?>" class="px" />&nbsp;&nbsp;JSAPI接口中获取openid</p>
										<p><span></span><a href="###" onclick="showWxhelp()" class="a_red">点击查看如何设置</a></p>
										<?php
 }else { ?>
										
										<a href="/index.php?g=User&m=Index&a=edit&id=<?php echo $wxuser['id'];?>" class="a_red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击这里先设置您的appid和appsecret&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<?php
 } ?>
						...
						<td>
							<div class="pay_setting">
								<div>
									...
									<a href="###" onclick="showSetting('platform','平台支付');" class="a_choose">配置信息</a>&nbsp;&nbsp;&nbsp;&nbsp;平台现在开启的是 <b style="color:red;"><?php if(C('pay_type') == 'alipay'): ?>支付宝<?php elseif(C('pay_type') == 'tenpay'): ?>财付通<?php endif; ?></b> ，开启平台支付后将在您的 <b style="color:red;"><?php if(C('pay_type') == 'alipay'): ?>支付宝<?php elseif(C('pay_type') == 'tenpay'): ?>财付通<?php endif; ?></b> 关闭时进行显示使用支付。
								</div>
