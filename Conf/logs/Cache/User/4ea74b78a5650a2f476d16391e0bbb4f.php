...
<a href="<?php echo U('Voteimg/menu_add',array('token'=>$token,'vote_id'=>$vote_id));?>" title="添加活动" class="right btnGrayS vm">添加菜单</a>
<a href="<?php echo U('Voteimg/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:1px">返回投票列表</a>
  ...
  <h2> 
	...
	<tr>
	  ...
	  <th style="width:30%;">菜单icon</th>
	  <th style="width:30%;">菜单链接</th>
	  <th style="width:10%;">是否隐藏</th>
	</th>
	<th>操作</th>
	</tr>
	</thead>
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  ...
		  <td><?php echo ($vo["menu_icon"]); ?></td>
		  <td><?php if($vo["type"] == 2): ?>---<?php else: echo ($vo["menu_link"]); endif; ?></td>
		  <td><?php if($vo["hide"] == 1): ?>否<?php else: ?>是<?php endif; ?></td>
		  <td class="norightborder">
		  <a href="<?php echo U('Voteimg/menu_add',array('id'=>$vo['id'],'vote_id'=>$vo['vote_id'],'token'=>$vo['token']));?>" class="btnGreen">编辑</a>  <?php if($vo["type"] == 1): ?><a href="<?php echo U('Voteimg/menu_del',array('menu_id'=>$vo['id']));?>" class="btnGreen">删除</a><?php endif; ?>
		  </td>
		</tr>
