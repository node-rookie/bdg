...
<ul>
	...
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/lockuser',array('token'=>$token));?>">黑名单管理</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
	<div class="pageNavigator left"> 
		<a href="<?php echo U('Storenew/lockset', array('token' => $token, 'cid' => $cid));?>" title="添加黑名单" class="btnGrayS vm bigbtn">
			<img src="<?php echo RES;?>/images/product/add.png" class="vm" />添加黑名单
		</a>
	</div>
</div>
<div class="msgWrap">
...
<td><?php echo ($hostlist['note']); ?></td>
<td class="norightborder">
	<a href="<?php echo U('Storenew/detail',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">佣金获取详情</a><br>
	<span><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/dellockuser',array('id'=>$hostlist['id'],'token'=>$token,'cid'=>$cid));?>');">删除</a>&nbsp;&nbsp;　|　&nbsp;&nbsp;<a href="<?php echo U('Storenew/remove',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">提现详情</a></span>
</td>
