...
<script type="text/javascript">
  ...
  <a href='<?php echo U('Autumns/add',array('token'=>$token));?>' title='新增<?php echo ($activityTypeName); ?>活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增<?php echo ($activityTypeName); ?>活动</a>
