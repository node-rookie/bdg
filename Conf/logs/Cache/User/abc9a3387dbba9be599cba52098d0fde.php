...
<a href="<?php echo U('Voteimg/add_item',array('token'=>$token,'vote_id'=>$vote_id));?>" class="btnGrayS vm bigbtn">添加投票选项</a>  
<a href="<?php echo U('Voteimg/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:1px">返回投票列表</a>
	...
	<tr>
	  ...
	  <th style="width:15%;">图片地址</th>
	  <th style="width:15%;">图片跳转地址</th>
	...
	<?php if($list != ''): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  ...
		  <td><img src="<?php echo ($vo["vote_img"]); ?>" width="100px" height="100px"/><input type="hidden" value="<?php echo ($vo["vote_img"]); ?>" id="img_<?php echo ($vo["id"]); ?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="viewImg('img_<?php echo ($vo["id"]); ?>')" href="###">&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#4a98e0;">预览</span></a></td>
		  <td><?php echo ($vo["jump_url"]); ?></td>
		  <td><?php echo ($vo["vote_count"]); ?></td>
		   <td><?php echo ($vo["contact"]); ?></td>
		  <td class="norightborder">
		  <a href="<?php echo U('Voteimg/edit_item',array('id'=>$vo['id'],'token'=>$token));?>" class="btnGreen">编辑选项</a>
		  <a href="<?php echo U('Voteimg/del_item',array('id'=>$vo['id']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
		</tr>
	  </tbody><?php endforeach; endif; else: echo "" ;endif; ?> 
	<?php else: ?>
		  <tbody><tr><td colspan="7" align="center">暂无投票选项,请添加</td></tr>
	  </tbody><?php endif; ?>
	</table>
