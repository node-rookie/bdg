...
<script src="<?php echo RES;?>/js/date/WdatePicker.js"></script>
	<div class="content">
		...
		<div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">
			注意：设置冲值区间请不要重叠，以免出现赠送金额不准确。赠送公式为：最小充值---(大于)--->赠送金额<---(小于或者等于)---最大冲值金额
		</div>
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
				 <tr>
					<th>充值金额</th>
					<td>
						<input type="input" class="px" value="<?php echo ($set["min_price"]); ?>" name="min_price" placeholder="最小充值" style="width:55px;"> 
						-
						<input type="input" class="px" value="<?php echo ($set["max_price"]); ?>" name="max_price" placeholder="最大冲值" style="width:55px;">
						&nbsp;&nbsp;冲值区间不限制请设置为“0”，如：冲值900以上赠送100，设置最小冲值位“900”，最大冲值为“0”
						</td>
				</tr>           		
				<tr>
					<th>赠送金额</th>
					<td>
						<input type="input" class="px"  value="<?php echo ($set["donate_price"]); ?>" name="donate_price" placeholder="赠送金额">
						&nbsp;&nbsp;设置达到赠送区间赠送的金额
					</td>
				</tr> 
				...
				<tr>
					<th>活动持续时间：</th>
					<td>	
						<input type="input" class="px" value="<?php if($set["start"] == ''): echo ($startdate); else: echo (date('Y-m-d',$set["start"])); endif; ?>" name="start" onClick="WdatePicker()">
						-
						<input type="input" class="px" value="<?php if($set["end"] == ''): echo ($enddate); else: echo (date('Y-m-d',$set["end"])); endif; ?>" name="end"   onClick="WdatePicker()">
					</td>
				</tr>
				-->
				...
				<tr>
					<th>充值赠送说明：</th>
					<td>
						<textarea class="px" id="donate_intro" name="donate_intro" style="width: 300px; height: 100px;"><?php echo ($donate_intro); ?></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<button type="submit" id="button" name="button" class="btnGreen">保存</button>
...
'insertunorderedlist', '|','table','anchor','preview','print','template','code','cut']
});
