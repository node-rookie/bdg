...
<td>
<?php if($o['paytype'] == 'daofu' or $o['paytype'] == 'dianfu'): ?><span style="color:green">到店付款</span>
<?php elseif($o['paid'] == 1): ?>
...
function showIntroDetail(id){
	art.dialog.open('<?php echo U('Hotels/orderInfo',array('token'=>$token,'cid'=>$cid));?>&id='+id,{lock:false,title:'订单详情',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87, close: function(){location.reload();}});
}
