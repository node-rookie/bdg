...
<div class="content">
	...
	<div class="cLine">
		<div class="pageNavigator left">
			<a href="<?php echo U('Unitary/add',array('token'=>$token));?>" title="新增活动商品" class="btnGrayS vm bigbtn"><img src="<?php echo ($staticPath); ?>/tpl/static/unitary/images/add.png" class="vm">新增活动商品</a>
		</div>
