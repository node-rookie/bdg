...
<ul>
	...
	<li class="current tabli" id="tab0"><a href="<?php echo U('Storenew/removesearch', array('token' => $token, 'cid' => $cid));?>">查看申请提现</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/detailinfo',array('token'=>$token));?>">查看分佣信息</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/twitter',array('token'=>$token));?>">商城分佣管理</a></li>
</ul>
</div>
<!--tab end-->
<!--div class="cLine">
...
<td><?php echo ($hostlist['number']); ?></td>
<td><?php echo ($hostlist['bank']); ?></td>
<td><?php echo ($hostlist['name']); ?></td>
<td><?php echo ($hostlist['tel']); ?></td>
<td><?php if($hostlist['status'] == 1): ?><span style="color:green">已提现</span><?php else: ?><span style="color:red">审核中</span><?php endif; ?></td>
<td><a href="javascript:drop_confirm('您确定已转账给该用户了吗?', '<?php echo U('Storenew/changestatus',array('token' => $token, 'id' => $hostlist['id'], 'twid' => $hostlist['twid']));?>');">转账修改</a></td>
