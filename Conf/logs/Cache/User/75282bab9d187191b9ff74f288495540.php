...
<form class="form" method="post" action="<?php echo U('Voteimg/add_voteimg',array('id'=>$action_id,'token'=>$token));?>" target="_top" enctype="multipart/form-data">
...
<td><input type="text" name="keyword" value="<?php if($vo['keyword'] == ''): ?>图文投票<?php else: echo ($vo["keyword"]); endif; ?>" class="px" style="width:550px;"><br><span class="red"><?php if($type == 'scene'): ?>添加现场投票，关键词设置失效，无需修改<?php else: ?>只能写一个关键词,功能面板必须开启投票<?php endif; ?></span></td>
</tr>
<tr>
<th width="120"><span class="red">*</span>活动名称：</th>
<td><input type="text" name="action_name" value="<?php echo ($vo["action_name"]); ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
...
<tr>
  <th>&nbsp;回复图片：</th>
  <td>
  <?php if($vo["reply_pic"] != ''): ?><img class="thumb_img" id="picurl_src1" src="<?php echo ($vo["reply_pic"]); ?>" style="max-height:100px;max-width: 200px;">
	<?php else: ?>
	<img class="thumb_img" id="picurl_src1" src="<?php echo ($staticPath); ?>/tpl/static/voteimg/img/2.png" style="max-height:100px;max-width: 200px;"><?php endif; ?>
...
<tr>
<th>活动时间：</th>
<td><input type="input" class="px" id="start_time" value="<?php echo (date("Y-m-d",($vo["start_time"])?($vo["start_time"]):time())); ?>" onClick="WdatePicker()" name="start_time">
到
<input type="input" class="px" id="end_time" value="<?php echo (date("Y-m-d",($vo["end_time"])?($vo["end_time"]):strtotime('+1 month'))); ?>" name="end_time" onClick="WdatePicker()"></td>
</tr>
<tr>
<th> <span class="red">*</span>限制投票数：</th>
<td>
  <input type="text" name="limit_vote" value="<?php echo ($vo["limit_vote"]); ?>"  class="px">&nbsp;&nbsp;&nbsp;&nbsp;(限制每个用户每个活动总的投票数，超过不让投票,请输入大于0的数)
</td>
</tr>
<tr>
<th><span class="red">*</span> 限制每天投票数：</th>
<td>
  <input type="text" name="limit_vote_day" value="<?php echo ($vo["limit_vote_day"]); ?>"  class="px">&nbsp;&nbsp;&nbsp;&nbsp;(限制每个用户每个活动每天的投票数，超过不让投票,请输入大于0的数)
</td>
</tr>
<tr>
<th> 电话：</th>
<td>
  <input type="text" name="phone" value="<?php echo ($vo["phone"]); ?>"  class="px">&nbsp;&nbsp;&nbsp;&nbsp;(商户联系方式,用于前台首页底部导航里的电话显示)
</td>
</tr>
<tr>
<th>未关注是否可以参与：</th>
<td>
  <input type="radio" name="is_follow" value="1" <?php if($vo["is_follow"] == '1' or $vo["is_follow"] == ''): ?>checked<?php endif; ?>>
  是
  <input type="radio" name="is_follow" value="2" <?php if($vo["is_follow"] == '2'): ?>checked<?php endif; ?>>否<div style="float:right;margin-right:495px;"><?php echo ($__access_remind__); ?></div>
</td>
</tr>
<tr>
<th>是否需要粉丝信息：</th>
<td>
  ...
  是
  <input type="radio" name="is_register" value="0" <?php if($vo["is_register"] == '0'): ?>checked<?php endif; ?>>否
  &nbsp;&nbsp;&nbsp;&nbsp;(没有粉丝详细信息参加活动的处理方式)
</td>
</tr>
<tr>
...
<td>
  ...
  开启
  　　
  <input type="radio" name="display" value="0" <?php if($vo["display"] == '0'): ?>checked<?php endif; ?>>关闭
</td>
</tr>
<tr>
<th>&nbsp;</th>
