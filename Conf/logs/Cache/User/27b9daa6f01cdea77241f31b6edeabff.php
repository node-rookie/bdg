...
<div class="cLine">
<div class="pageNavigator left"><a href="<?php echo U('Eqx/index',array('token'=>$token));?>" title="添加新的场景关键词" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加新的场景关键词</a></div>
...
<td class="norightborder">
	<a href="<?php echo U('Eqx/set',array('id'=>$item['id'],'token'=>$token,'sceneid_bigint'=>$item['sceneid_bigint']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Eqx/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
