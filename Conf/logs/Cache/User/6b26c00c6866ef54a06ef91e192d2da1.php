...
<a href="<?php echo U('Voteimg/add_voteimg',array('token'=>$token,'id'=>$id));?>" class="btnGrayS vm bigbtn">添加图片投票</a>  
</div>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  ...
		  <a href="<?php echo U('Voteimg/banner_manage',array('vote_id'=>$vo['id'],'token'=>$token));?>" class="btnGreen">banner管理</a>
