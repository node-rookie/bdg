...
<tbody>
<tr></tr>
<?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($key % 2 );++$key;?><tr>
<td><?php echo ($key); ?></td>
<td><?php echo ($item["username"]); ?></td>
<td><?php echo ($item["sharename"]); ?></td>
<td><?php echo ($item["mobile"]); ?></td>
<td><?php echo ($item["help_count"]); ?>点<br>分享：<?php echo ($item["sharecount"]); ?>次<br>给力值：<?php echo ($item["number"]); ?>%<br>积分：<?php echo ($item["help_score"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$item["add_time"])); ?></td> 
<td class="norightborder">
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Helping/rank_del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a>
</td>
