...
<ul>
	...
	<li class="current tabli" id="tab0"><a href="<?php echo U('Storenew/product',array('token'=>$token, 'cid'=>$cid));?>">商品管理</a></li>
...
<a href="<?php echo U('Storenew/addNew', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加商品</a>
</div><?php endif; ?>
<div class="pageNavigator right">
	<a href="<?php echo U('Storenew/index',array('token'=>$token,'catid'=>$catid));?>" class="btnGrayS vm bigbtn">返回</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($hostlist["num"]); ?></td>
<td><?php echo ($hostlist["salecount"]); ?></td>
<td><?php echo ($hostlist["keyword"]); ?></td>
<td><?php echo ($hostlist["catname"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?></td> 
<td class="norightborder" align="center">
	<a href="<?php echo U('Storenew/addNew',array('id' => $hostlist['id'], 'token' => $token,'catid' => $hostlist['catid']));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/del',array('id'=>$hostlist['id'],'token'=>$token,'catid'=>$hostlist['catid']));?>');">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Storenew/comment', array('pid'=>$hostlist['id'],'token'=>$token,'catid'=>$hostlist['catid']));?>">用户评论</a>
</td>
