...
<div class="content">
        <div class="cLineB">
			<h4><?php echo ($thisCard["cardname"]); ?>：发布积分抽奖 <span class="FAQ">发布积分抽奖信息</span></h4>
          ...
          <div class="msgWrap form">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
				...
				<tr>
					<th>中奖概率：</th>
					<td><input type="input" class="px" id="ranknum" value="<?php echo ($vip["ranknum"]); ?>" name="ranknum" style="width:50px;"> 中奖概率=概率/数量，每次都中奖填写数值 1 ，如果开启永远不中奖，填写多少都行
				</td>
				</tr>
				<tr>
					<th>每天抽奖次数：</th>
					<td><input type="input" class="px" id="daynum" value="<?php echo ($vip["daynum"]); ?>" name="daynum" style="width:50px;"> 当天可抽奖次数
				</td>
				</tr>
              	<tr>
					<th>抽奖有效期：</th>
				 ...
				 <TR>
					<th valign="top"><span class="red"></span>是否永远不中奖：<br/>(嘿嘿，你懂得！)</th>
					<td>
					<input type="radio" name="islottery" value="1" <?php if($set['islottery'] == '' or $set['islottery'] == '1'): ?>checked<?php endif; ?>>是&nbsp;&nbsp;&nbsp;
					<input type="radio" name="islottery" value="0" <?php if($set['islottery'] == '0'): ?>checked<?php endif; ?>>否
					</td>
				</TR>
				<tr>
				  <th>奖品图片：</th>
