...
<TR>
  ...
  <TD>
    <input class="px"  name="top_pic" value="<?php if($set['top_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/helping/images/default.jpg<?php else: echo ($set["top_pic"]); endif; ?>" id="pic2" style="width:310px;"  />
    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a><br />100*100转发小图
  </TD>
</tr>
<TR>
	<th><span class="red">*</span>活动时间：</th>
	<td><input type="input" class="px" id="statdate" value="<?php if($set['start'] != ''): echo (date("Y-m-d H:i:s",$set["start"])); else: echo ($start_date); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd  HH:mm:ss'})" name="start" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($set['end'] != ''): echo (date("Y-m-d H:i:s",$set["end"])); else: echo ($end_date); endif; ?>" name="end"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd  HH:mm:ss'})"  />
	</td>
</TR>
<tr>
  	<th valign="top"><span class="red"></span>活动介绍：</th>
  	<td>
  		<textarea class="px" id="desc" name="intro" style="width:400px; height: 100px;"><?php echo ($set["intro"]); ?></textarea>
  	</td>
</tr>
<TR>
...
<tr class="alis">
	...
	<td><input style="width:55px;" type="text" name="minscore" value="<?php echo ($set["minscore"]); ?>" class="px" >~~~~~~<input style="width:55px;" type="text" name="maxscore" value="<?php echo ($set["maxscore"]); ?>" class="px" ></td>
</tr>
 <TR>
  <th valign="top"><span class="red"></span>开启赠送积分：</th>
  <td>
  <input type="radio" name="is_score" value="1" <?php if($set['is_score'] == 1): ?>checked<?php endif; ?>>开启&nbsp;&nbsp;&nbsp;
  <input type="radio" name="is_score" value="2" <?php if($set['is_score'] == '' or $set['is_score'] == 2): ?>checked<?php endif; ?>>关闭
  &nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;
  （是否开启分享人可以通过别人助力获取积分）
</td>
...
<div class="msgWrap bgfc">
    <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;">温馨提示：奖项最多设置3个。单个奖项参数请填写完整，奖品图片宽高比例请尽量一致(正方形100*100)
    </div>
    <TABLE class="userinfoArea" style=" margin: 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
        <TBODY>
        <TR>
            <th valign="top"><span class="red">*</span>一等奖：</th>
            <td><input type="input" class="px" id="frist"  name="frist" value="<?php echo ($set["frist"]); ?>"  style="width:250px"/>
                请不要多于50字! </td>
        ...
        <tr>
            ...
            <td>
                <input class="px"  name="fristpic" value="<?php echo ($set["fristpic"]); ?>" id="pic3" style="width:200px;"  />
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic3',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic3')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red">*</span>奖品数量：</th>
            <td>
                <input type="input" class="px" name="fristnums" value="<?php echo ($set["fristnums"]); ?>" style="width:80px" />
            </td>
        </TR>
		<TR>
            <th valign="top"><span class="red"></span>中奖规则：</th>
            <td>
                <input type="input" class="px" name="fristdoc" value="<?php echo ($set["fristdoc"]); ?>" style="width:80px" />
            </td>
        </TR>
        ...
        <TR>
            <th valign="top"><span class="red"></span>二等奖：</th>
            <td><input type="input" class="px" id="second"  name="second" value="<?php echo ($set["second"]); ?>"  style="width:250px"/>
                请不要多于50字! </td>
            <TD rowspan="9" valign="top">&nbsp;</TD>
        </TR>
        <tr>
            <th><span class="red"></span>奖品图片</th>
            <td>
                <input class="px"  name="secondpic" value="<?php echo ($set["secondpic"]); ?>" id="pic4" style="width:200px;"  />
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic4',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic4')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
            <td>
                <input type="input" class="px" name="secondnums" value="<?php echo ($set["secondnums"]); ?>" style="width:80px" />
            </td>
        </TR>
		<TR>
            <th valign="top"><span class="red"></span>中奖规则：</th>
            <td>
                <input type="input" class="px" name="seconddoc" value="<?php echo ($set["seconddoc"]); ?>" style="width:80px" />
            </td>
        </TR>
        ...
        <TR>
            <th valign="top"><span class="red"></span>三等奖：</th>
            <td><input type="input" class="px" id="third"  name="third" value="<?php echo ($set["third"]); ?>"  style="width:250px"/>
                请不要多于50字! </td>
            <TD rowspan="9" valign="top">&nbsp;</TD>
        </TR>
        <tr>
            <th><span class="red"></span>奖品图片</th>
            <td>
                <input class="px"  name="thirdpic" value="<?php echo ($set["thirdpic"]); ?>" id="pic5" style="width:200px;"  />
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic5',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic5')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
            <td>
                <input type="input" class="px" name="thirdnums" value="<?php echo ($set["thirdnums"]); ?>" style="width:80px" />
            </td>
        </TR>
		<TR>
            <th valign="top"><span class="red"></span>中奖规则：</th>
            <td>
                <input type="input" class="px" name="thirddoc" value="<?php echo ($set["thirddoc"]); ?>" style="width:80px" />
            </td>
        </TR>
        ...
        <TR>
            <th valign="top"><span class="red"></span>四等奖：</th>
            <td><input type="input" class="px" id="four"  name="four" value="<?php echo ($set["four"]); ?>"  style="width:250px"/>
                请不要多于50字! </td>
            <TD rowspan="9" valign="top">&nbsp;</TD>
        </TR>
        <tr>
            <th><span class="red"></span>奖品图片</th>
            <td>
                <input class="px"  name="fourpic" value="<?php echo ($set["fourpic"]); ?>" id="pic6" style="width:200px;"  />
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic6',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic6')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
            <td>
                <input type="input" class="px" name="fournums" value="<?php echo ($set["fournums"]); ?>" style="width:80px" />
            </td>
        </TR>
		<TR>
            <th valign="top"><span class="red"></span>中奖规则：</th>
            <td>
                <input type="input" class="px" name="fourdoc" value="<?php echo ($set["fourdoc"]); ?>" style="width:80px" />
            </td>
        </TR>
        ...
        <TR>
            <th valign="top"><span class="red"></span>五等奖：</th>
            <td><input type="input" class="px" id="five"  name="five" value="<?php echo ($set["five"]); ?>"  style="width:250px"/>
                请不要多于50字! </td>
            <TD rowspan="9" valign="top">&nbsp;</TD>
        </TR>
        <tr>
            <th><span class="red"></span>奖品图片</th>
            <td>
                <input class="px"  name="fivepic" value="<?php echo ($set["fivepic"]); ?>" id="pic7" style="width:200px;"  />
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic7',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic7')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
            <td>
                <input type="input" class="px" name="fivenums" value="<?php echo ($set["fivenums"]); ?>" style="width:80px" />
            </td>
        </TR>
		<TR>
            <th valign="top"><span class="red"></span>中奖规则：</th>
            <td>
                <input type="input" class="px" name="fivedoc" value="<?php echo ($set["fivedoc"]); ?>" style="width:80px" />
            </td>
        </TR>
