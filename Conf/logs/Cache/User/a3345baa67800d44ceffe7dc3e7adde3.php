...
<!--活动开始-->
<div class="cLineB">
    <h4>编辑幸运九宫格活动开始内容</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): ?>九宫格<?php else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		<img id="pic1_src" src="<?php if($vo['starpicurl'] == ''): echo ($staticPath); ?>/tpl/static/jiugong/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >
		<br />
		<input class="px"  name="starpicurl" value="<?php if($vo['starpicurl'] == ''): echo ($staticPath); ?>/tpl/static/jiugong/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" id="pic1" style="width:363px;"  />
		<br />
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($vo['title'] == ''): ?>幸运九宫格活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
 </TR>
...
<td><textarea  class="px" id="info" name="info"  style="width:400px; height:125px" ><?php if($vo['info'] == ''): ?>亲，请点击进入九宫格抽奖活动页面，祝您好运哦！<?php else: echo ($vo["info"]); endif; ?></textarea><br />换行请输入
 &lt;br&gt;
 </td>
</TR>
<TR>
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>幸运九宫格活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="pic2_src" src="<?php if($vo['endpicurl'] == ''): echo ($staticPath); ?>/tpl/static/jiugong/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px" id="pic2"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo ($staticPath); ?>/tpl/static/jiugong/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  style="width:363px;"  />
  					<br />
...
<TR>
<th valign="top"><span class="red">*</span>一等奖奖品图片：</th>
<td>
<input type="input" class="px" id="fistpic"  name="fistpic" value="<?php echo ($vo["fistpic"]); ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fistpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fistpic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
<TR>
...
<TR>
<th valign="top">二等奖奖品图片：</th>
<td>
<input type="input" class="px" id="secondpic"  name="secondpic" value="<?php if($vo['secondpic'] == ''): else: echo ($vo["secondpic"]); endif; ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('secondpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('secondpic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
<TR>
...
<TR>
<th valign="top">三等奖奖品图片：</th>
<td>
<input type="input" class="px" id="thirdpic"  name="thirdpic" value="<?php if($vo['thirdpic'] == ''): else: echo ($vo["thirdpic"]); endif; ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('thirdpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('thirdpic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
<TR>
...
<TR>
<th valign="top">四等奖奖品图片：</th>
<td>
<input type="input" class="px" id="fourpic"  name="fourpic" value="<?php if($vo['fourpic'] == ''): else: echo ($vo["fourpic"]); endif; ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fourpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fourpic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
<TR>
...
<TR>
<th valign="top">五等奖奖品图片：</th>
<td>
<input type="input" class="px" id="fivepic"  name="fivepic" value="<?php if($vo['fivepic'] == ''): else: echo ($vo["fivepic"]); endif; ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fivepic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fivepic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
<TR>
...
<TR>
<th valign="top">六等奖奖品图片：</th>
<td>
<input type="input" class="px" id="sixpic"  name="sixpic" value="<?php if($vo['sixpic'] == ''): else: echo ($vo["sixpic"]); endif; ?>"  style="width:250px"/>
<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('sixpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('sixpic')">预览</a>&nbsp; 请上传方形图片。
</td>
</TR>
...
<td><input type="input" class="px" id="canrqnums" name="canrqnums"   value="<?php if(($vo["canrqnums"] == null) OR ($vo["canrqnums"] == 0)): ?>1<?php else: echo ($vo["canrqnums"]); endif; ?>" style="width:150px"/>
必须是数字</td>
 </TR>
 <tr>
...
<TR>
	...
	<td><input class="radio" type="radio" name="guanzhu" value="0"  <?php if($vo['guanzhu'] == 0): ?>checked<?php endif; ?>> 是 <input class="radio" type="radio" name="guanzhu" value="1"  <?php if($vo['guanzhu'] == 1): ?>checked<?php endif; ?> > 否<?php echo ($__access_remind__); ?>
</td>
</TR>
<TR>
	<th valign="top">是否需要粉丝详细信息：</th>
	<td><input class="radio" type="radio" name="needreg" value="1"  <?php if($vo['needreg'] == 1): ?>checked<?php endif; ?> > 是  <input class="radio" type="radio" name="needreg" value="0"  <?php if($vo['needreg'] == 0): ?>checked<?php endif; ?>> 否 <br/>（没有粉丝详细信息参加活动的处理方式）</td>
</TR>
<TR>
<th>&nbsp;</th>
