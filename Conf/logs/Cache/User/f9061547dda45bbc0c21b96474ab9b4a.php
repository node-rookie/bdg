...
<div class="cLineC" style="line-height: 18px;">
 <a href="javascript:add_device()" class="btnGrayS vm bigbtn" >添加设备</a>　 <a href="<?php echo U('Shakearound/manual_update',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:4px">手动更新设备状态</a>
</div>
...
<?php elseif($li["status"] == 1): ?>已激活但不活跃
<?php else: ?> 活跃<?php endif; ?></td>
