...
afterBlur: function(){this.sync();}
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>新闻资讯</h4> 
    <a href="<?php echo U('Storenew/news',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        ...
        <td>
        <input type="text" name="title" id="title" value="<?php echo ($set["title"]); ?>" class="px" style="width:400px;" />
        </td> 
       </tr> 
       <tr> 
        <th>是否显示：</th> 
        <td>
	        ...
	        <input type="radio" name="status" class="status" value="1" id="status_1" <?php if($set['status'] == 1): ?>checked<?php endif; ?> /><label for="status_1">隐藏</label>
		</td> 
       </tr>
	   
       <tr> 
        <th>转发缩略图：</th>
        <td><input type="text" name="share_pic" value="<?php echo ($set["share_pic"]); ?>" class="px" id="pic" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       </tr>
       ...
       <TR>
          ...
          <TD><textarea name="info" id="info"  rows="5" style="width:590px;height:360px"><?php echo ($set["info"]); ?></textarea></TD>
       </TR>

       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Storenew/news',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
