  ...
  <div class="msgWrap">
    <form class="form" method="post" action=""  id="formID" target="_top" enctype="multipart/form-data">
      <table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
          <tr>
           <?php if($comments['cid'] != ''): ?><input type="hidden" class="px" id="cid" value="<?php echo ($comments['cid']); ?>" name="cid" >
            ...
            <th valign="top"><label for="title">标题：</label></th>
            <td><input type="input" class="px" id="title" value="<?php echo ($comments['title']); ?>" name="title" style="width:400px" data-validation-engine="validate[required,minSize[2],maxSize[20]]" data-errormessage-value-missing="必填项">
              <br>
            </td>
            <td></td>
          </tr>
          <tr>
            <th valign="top"><label for="name">姓名：</label></th>
            <td><input type="input" class="px" id="name" value="<?php echo ($comments['name']); ?>" name="name"  data-validation-engine="validate[required,minSize[2],maxSize[8]]" data-errormessage-value-missing="必填项">
              <br>
            </td>
            <td></td>
          </tr>
          <tr>
            <th valign="top"><label for="position">职位：</label></th>
            <td><input type="input" class="px" id="position" value="<?php echo ($comments['position']); ?>" name="position"  data-validation-engine="validate[required,minSize[2],maxSize[20]]" data-errormessage-value-missing="必填项">
              <br>
            </td>
            <td></td>
          </tr>
          <tr>
            <th valign="top"><label for="face_picurl">照片：</label></th>
            <td><?php if($comments['face_picurl'] != ''): ?><img class="thumb_img" id="face_picurl_src" src="<?php echo ($comments['face_picurl']); ?>" style="max-height:100px;max-width: 150px;"><?php endif; ?>
            <input type="input" class="px" id="face_picurl" value="<?php echo ($comments['face_picurl']); ?>" name="face_picurl" data-validation-engine="validate[required,custom[url]]"
...
<a href="###" onclick="upyunPicUpload('face_picurl',468,180,'<?php echo ($token); ?>')" class="a_upload">上传</a>
<a href="###" onclick="viewImg('face_picurl')">预览</a> [468*180] </td>
            <td></td>
          </tr>
          <tr>
            <th valign="top"><label for="face_desc">介绍：</label></th>
            <td>
<textarea class="px" id="face_desc" name="face_desc" style="width: 605px; height: 350px;"  data-validation-engine="validate[required,minSize[2]]" data-errormessage-value-missing="必填项"><?php echo ($comments['face_desc']); ?></textarea>
            </td>
            <td></td>
          </tr>
          <tr>
            <th valign="top"><label for="sort">显示顺序：</label></th>
            <td><input type="input" class="px" id="sort" value="<?php echo (($comments['sort'])?($comments['sort']):1); ?>" name="sort"  data-validation-engine="validate[required,custom[integer],min[1]]" data-errormessage-value-missing="必填项">
              数字越大,越在前面显示.
              </td>
            <td></td>
          </tr>
...
租赁公司
      <?php elseif($type == 'beauty'): ?>
美容公司<?php endif; ?> </label></th>
            <td><select name="bid_id" id="bid_id" data-validation-engine="validate[required]" data-errormessage-value-missing="必填项">
                <option value="">请选择</option>
                <?php if(is_array($busines_list)): $i = 0; $__LIST__ = $busines_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["bid"]); ?>" <?php if($vo["bid"] == $comments['bid_id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["mtitle"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
              <br>
            </td>
            <td></td>
          ...
          <tr>
            <th valign="top"><label for="comment">点评内容：</label></th>
            <td>
<textarea class="px" id="comment" name="comment" style="width: 605px; height: 350px;"  data-validation-engine="validate[required,minSize[2]]" data-errormessage-value-missing="必填项"><?php echo ($comments['comment']); ?></textarea>
