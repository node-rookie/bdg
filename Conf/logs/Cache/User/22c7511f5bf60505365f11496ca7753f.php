            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR align="center">
                  ...
                  <TH>文字颜色</TH>
                  <TH>状态</TH>
                  <TH class="norightborder">模板ID</TH>
                </TR>
              </THEAD>
              <TBODY>
                <form action="" method="post">
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td><input type="hidden" name="industry[]" value="<?php echo ($t["industry"]); ?>" /><pre><?php echo ($t["industry"]); ?></pre></td>
                      ...
                      <td class="norightborder"><input type="text" class="px" name="tempid[]" value="<?php echo ($t["tempid"]); ?>" /></td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                  <tr>
                    <td colspan="7" align="center"><button class="btnGreen">保存</button></td>
                  </tr>
              </form>      
              </TBODY>
            </TABLE>
