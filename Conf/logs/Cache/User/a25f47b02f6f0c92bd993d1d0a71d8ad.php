     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
	  ...
	  <!--
	   ...
	   <tr> 
        <th>营业时间：</th>
        <td>
		从 <input type="input" class="px" name="starttime" id="starttime" value="<?php if($company['starttime'] > 0): echo (date("H:i",$company['starttime'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 开始
		&nbsp; 到 &nbsp;
		<input type="input" class="px" name="endtime" id="endtime" value="<?php if($company['endtime'] > 0): echo (date("H:i",$company['endtime'])); endif; ?>"  onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 结束
