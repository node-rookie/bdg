...
<div>
  <div class="cLineB">
    <h4><a href="<?php if ($fid==0){ echo U('Classify/flash',array('tip'=>3,'id'=>$id)); }else{ echo U('Classify/flash',array('tip'=>3,'id'=>$id,'fid'=>$fid)); }?>" class="btnGrayS vm bigbtn">幻灯片管理</a>
    <a href="<?php if ($fid==0){ echo U('Classify/flash',array('tip'=>4,'id'=>$id)); }else{ echo U('Classify/flash',array('tip'=>4,'id'=>$id,'fid'=>$fid)); }?>" class="btnGrayS vm bigbtn">背景图管理</a></h4>
          <div class="clr"></div>
      <a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
  </div>

 </div>
         <div class="cLi" style="line-height: 32px;margin-top:10px">

 <a href="<?php if ($fl['fid']==0){ echo U('Classify/addflash',array('tip'=>$tip,'id'=>$id)); }else{ echo U('Classify/addflash',array('tip'=>$tip,'id'=>$id,'fid'=>$fl['fid'])); }?>" class="btnGrayS vm bigbtn" >添加【<?php echo ($fl['name']); ?>】分类<?php if($tip == 3): ?>幻灯片<?php else: ?>背景图<?php endif; ?></a>
...
<tr>
                   ...
                   <th style=" width:120px;"><?php if($tip == 3): ?>幻灯片<?php else: ?>背景图<?php endif; ?>描述</th>

<th style="width:120px"><?php if($tip == 3): ?>幻灯片<?php else: ?>背景图<?php endif; ?>图片 <a  target="999" class="tooltips">
</span></a></th>
                        <th><?php if($tip == 3): ?>幻灯片<?php else: ?>背景图<?php endif; ?>外链地址<span class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
...
<td><div class="cateimg"><img src="<?php echo ($vo["img"]); ?>" class="cateimg_small" style="margin-left:20px" /><img src="<?php echo ($vo["img"]); ?>" class="cateimg_big"  /></div></td>
...
<td class="norightborder">
  ...
  <a href="<?php echo U('Classify/editflash',array('id'=>$vo['id'],'tip'=>$tip));?>">编辑</a>

  <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Classify/delflash',array('id'=>$vo['id'],'tip'=>$tip));?>');">删除</a>
</td>
