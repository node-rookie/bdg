...
<li <?php if($tab == 'tongji'): ?>class="selectTag"<?php endif; ?>>
				<a href="<?php echo U('Share/tongji');?>">分享统计</a> 
			</li>
...
<?php if(in_array($item['user']['wecha_id'], $arry)): else: ?>                            
 <?php  array_push($arry,$item['user']['wecha_id']); ?>                       
<TD><?php echo ($item["user"]["truename"]); ?></TD>
<TD><?php echo ($item["user"]["tel"]); ?></TD>
<TD>2014-10-01至<?php echo (date('Y-m-d',$item["time"])); ?></TD>
<!--<TD><?php echo date('Y-m-d H:i:s',$item['time']);?></TD>-->
<TD class="norightborder"><?php $idd=$item['user']['wecha_id'];echo$ac["$idd"]?></TD><?php endif; ?>
