...
<td colspan="2">自己设计背景：
	...
	<input type="button" onclick="document.getElementById(&#39;cardbg&#39;).src=document.getElementById(&#39;bg&#39;).value;" value="显示效果" class="btnGrayS"> 
	  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('bgs',1000,600,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('bgs')">预览</a> 背景图
</td>
</tr>
<tr>
<td colspan="2">
