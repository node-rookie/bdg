...
<form class="form" method="post"   action="<?php echo U('Service/doadd',array('token'=>$token,'type'=>'setup'));?>"  target="_top" enctype="multipart/form-data">
	<div class="content">
		<div class="cLineB">
			<h4 class="left">添加客服</h4>
			<a href="<?php echo U('Service/servicelist',array('token'=>$token,'type'=>'setup'));?>" class="right btnGreen">返回</a>
		</div>
		<div class="msgWrap bgfc">
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tr>
					<th>选择客服openid：</th>
					<td colspan="2">
						<input name="openid" id="fans_id" class="px" style="width:250px;">
				...
				<tr>
					<th>客服头像：</th>
					<td>
						<input type="input" class="px" id="headimgurl"  name="headimgurl" value=""  style="width:250px"/>
						<a href="###" onclick="upyunPicUpload('headimgurl',114,114,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('headimgurl')">预览</a>
					</td>
				</tr>
				<tr>
					<th>客服昵称：</th>
					<td>
						<input type="input" class="px" id="servicenickname"  name="nickname" value=""  style="width:250px"/>
					</td>
				</tr>
				<tr>
					<th valign="top">描述：</th>
					<td>
						<textarea  class="px" id="desc" name="desc"  style="width:400px; height:125px" ></textarea>
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
