     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        ...
        <td>
        <input type="text" name="name" id="name" value="<?php echo ($tableData["name"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>普通价格：</th> 
        <td>
        <input type="text" name="price" id="price" value="<?php echo ($tableData["price"]); ?>" class="px" style="width:50px;" /> (元)
        </td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>会员价格：</th> 
        <td>
        <input type="text" name="vprice" id="vprice" value="<?php echo ($tableData["vprice"]); ?>" class="px" style="width:50px;" /> (元)
        </td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>容纳人数：</th> 
        <td>
        <input type="text" name="num" id="num" value="<?php echo ($tableData["num"]); ?>" class="px" style="width:50px;" /> (位)
        </td> 
       </tr> 
       <tr> 
        <th>房间面积：</th> 
        <td>
        <input type="text" name="area" id="area" value="<?php echo ($tableData["area"]); ?>" class="px" style="width:50px;" /> (㎡)
        </td> 
       </tr> 
       <tr> 
        <th>床位增加说明：</th> 
        <td>
        <input type="text" name="bed" id="bed" value="<?php echo ($tableData["bed"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr> 
       <tr> 
        <th>所在楼层：</th> 
        <td>
        <input type="text" name="floor" id="floor" value="<?php echo ($tableData["floor"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr> 
       <tr> 
        <th>床宽说明：</th> 
        <td>
        <input type="text" name="bedwidth" id="bedwidth" value="<?php echo ($tableData["bedwidth"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr> 
       <tr> 
        <th>网络情况：</th> 
        <td>
        <input type="text" name="network" id="network" value="<?php echo ($tableData["network"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr> 
       <tr> 
        <th>吸烟说明：</th> 
        <td>
        <input type="text" name="smoke" id="smoke" value="<?php echo ($tableData["smoke"]); ?>" class="px" style="width:200px;" />
        </td> 
       </tr>
       <tr> 
        <th>展示图片一：</th>
        <td><input type="text" name="image_1" value="<?php echo ($tableData["image_1"]); ?>" class="px" id="image1" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('image1',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('image1')">预览</a></td> 
       </tr>
       <tr> 
        <th>展示图片二：</th>
        <td><input type="text" name="image_2" value="<?php echo ($tableData["image_2"]); ?>" class="px" id="image2" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('image2',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('image2')">预览</a></td> 
       </tr>
       <tr> 
        <th>展示图片三：</th>
        <td><input type="text" name="image_3" value="<?php echo ($tableData["image_3"]); ?>" class="px" id="image3" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('image3',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('image3')">预览</a></td> 
       </tr>
       <tr> 
        <th>展示图片四：</th>
        <td><input type="text" name="image_4" value="<?php echo ($tableData["image_4"]); ?>" class="px" id="image4" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('image4',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('image4')">预览</a></td> 
       </tr>
       <tr> 
        <th>描述：</th> 
