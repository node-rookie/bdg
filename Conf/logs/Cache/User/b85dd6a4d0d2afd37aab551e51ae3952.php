...
<form class="form" method="post"   action="<?php echo U('Cutprice/doadd',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data" >
	<div class="content">
		<div class="cLineB">
					...
					<tr>
						...
						<td rowspan="999" valign="top">
							<div style="margin-left:20px">
								<img id="wxpic_src" src="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wximg.jpg" width="373px" >
								<br/>
								<input class="px"  name="wxpic" value="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wximg.jpg" id="wxpic" style="width:363px;"  />
