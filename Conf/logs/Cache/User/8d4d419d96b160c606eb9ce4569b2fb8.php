...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Helping/set',array('token'=>$token));?>" title="添加活动" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加活动</a></div>
