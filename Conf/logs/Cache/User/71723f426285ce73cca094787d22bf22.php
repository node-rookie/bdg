...
<div class="content">
<div class="cLineB">
<h4 class="left">竞拍商品管理(<?php echo ($page); ?>)</h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
<ul>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/jingpaiset', array('token' => $token, 'cid' => $cid));?>">添加竞拍商品</a></li>
	<li class="current tabli" id="tab8"><a href="<?php echo U('Storenew/jingpai',array('token'=>$token,'cid' => $cid));?>">竞拍管理</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/jingpaiorders',array('token'=>$token,'cid'=>$cid));?>">竞拍订单</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/xin',array('token'=>$token,'cid'=>$cid));?>">竞拍设置</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left">
<a href="<?php echo U('Storenew/jingpaiset', array('token' => $token, 'cid' => $cid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加竞拍商品</a>
</div>
<div class="pageNavigator right">
	<a href="<?php echo U('Storenew/jingpaiorders',array('token'=>$token,'cid'=>$cid));?>" class="btnGrayS vm bigbtn">查看竞拍订单</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($hostlist["name"]); if($hostlist["status"] == '1'): ?><br><font color="red">[已下架]</font><?php endif; ?></td>
<td><?php echo ($hostlist["lowprice"]); ?>元</td>
<td><?php echo ($hostlist["increase"]); ?>元</td>
<td><?php echo ($hostlist["price"]); ?></td>
<td><?php echo ($hostlist["truename"]); ?></td>
<td><?php echo (date("Y-m-d",$hostlist["lasttime"])); ?><br><?php echo (date("H:i:s",$hostlist["lasttime"])); ?></td>
<td><?php echo ($hostlist["allcount"]); ?></td>
<td>创建时间:<?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?><br>起拍时间:<?php echo (date("Y-m-d H:i:s",$hostlist["starttime"])); ?><br>结束时间:<?php echo (date("Y-m-d H:i:s",$hostlist["endtime"])); ?></td> 
<td class="norightborder" align="center">
	<a href="<?php echo U('Storenew/jingpaiset',array('id' => $hostlist['id'], 'token' => $token,'cid' => $cid));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<?php if($hostlist["endtime"] > time() && $hostlist["is_order"] != '1'): ?><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Storenew/deljingpai',array('id'=>$hostlist['id'],'token'=>$token,'cid'=>$cid));?>');">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
	<a href="<?php echo U('Storenew/jingpairule', array('pid'=>$hostlist['id'],'token'=>$token,'cid'=>$cid));?>">竞拍记录</a>
	<?php if($hostlist["endtime"] < time() && $hostlist["is_order"] != '1'): ?><br/>
	<a href="javascript:drop_confirm('您确定要生成订单吗?一旦生成，无法删除用户订单记录', '<?php echo U('Storenew/addjingpaiorder',array('id'=>$hostlist['id'],'token'=>$token,'cid'=>$cid));?>');">生成用户订单</a>
	<?php elseif($hostlist["endtime"] < time() && $hostlist["is_order"] == '1'): ?>
	<br/>
	<a href="javascript:0);">订单已生成</a><?php endif; ?>
</td>
