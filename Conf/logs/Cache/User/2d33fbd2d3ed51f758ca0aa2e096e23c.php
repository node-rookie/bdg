...
<div class="content">
  ...
  <div class="msgWrap">
    <form class="form" method="post" action="<?php echo U('Seckill/action_add', array("type" => $_GET['type']));?>" method="post" id="formID" target="_top" enctype="multipart/form-data">
        ...
        <tbody>
            ...
            <tr>
              ...
              <?php if($reply_pic != ''): ?><img class="thumb_img" id="picurl_src1" src="<?php echo ($reply_pic); ?>" style="max-height:100px;max-width: 200px;">
				<?php else: ?>
				 <img class="thumb_img" id="picurl_src1" src="<?php echo ($f_siteUrl); ?>/tpl/static/seckill/images/banner.png" style="max-height:100px;max-width: 200px;"><?php endif; ?>
              <input type="text" name="reply_pic" value='<?php if($reply_pic != ''): echo ($reply_pic); else: echo ($f_siteUrl); ?>/tpl/static/seckill/images/banner.png<?php endif; ?>' id="pic1" class="px" style="width:200px;" >
			...
			<a href="###" onclick="upyunPicUpload('picurl',540,168,'<?php echo ($token); ?>')" class="a_upload">上传</a>
			<a href="###" onclick="viewImg('picurl')">预览</a> [540*168] </td>
            <td></td>
          </tr>

            <tr>
              <th valign="top"><label for="action_sdate"><span class="red">*</span>活动开始时间：</label></th>
              <td><input type="input" class="px" id="action_sdate" value="<?php echo (date('Y-m-d',($set["action_sdate"])?($set["action_sdate"]):time())); ?>" name="action_sdate" style="width:100px" data-validation-engine="validate[required,minSize[2],maxSize[20]]" onClick="WdatePicker()" data-errormessage-value-missing="必填项">
            ...
            <tr>
              ...
              <td><input type="input" class="px" id="action_edate" value="<?php echo (date('Y-m-d',($set["action_sdate"])?($set["action_sdate"]): strtotime('+1 month'))); ?>" name="action_edate" style="width:100px" data-validation-engine="validate[required,minSize[2],maxSize[20]]" onClick="WdatePicker()" data-errormessage-value-missing="必填项">
              <input type="input" class="px" id="action_sdate" value="<?php echo (date('H',$action_edate)); ?>" name="action_edate_h" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 时
                <input type="input" class="px" id="action_sdate" value="<?php echo (date('i',$action_edate)); ?>" name="action_edate_i" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 分
                &nbsp;&nbsp;&nbsp;      活动结束时间
              </td>
              <td></td>
            </tr>
			...
			<tr>
              ...
              <td>
                ...
                <input name="action_is_attention" type="radio" value = '2' id="action_rule" <?php if($action_is_attention == 2): ?>checked<?php endif; ?> /> 否 <div style="float:right;margin-right:520px;"><?php echo ($__access_remind__); ?></div>
              </td>
              <td></td>
            </tr>
            <tr>
