...
<form class="form" method="post"   action="<?php echo U('Bargain/doadd',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data" >
	<div class="content">
		<div class="cLineB">
					...
					<tr>
						...
						<td rowspan="999" valign="top">
							<div style="margin-left:20px">
								<img id="wxpic_src" src="<?php echo ($staticPath); ?>/tpl/static/bargain/images/wxnewspic.jpg" width="373px" >
								<br/>
								<input class="px"  name="wxpic" value="<?php echo ($staticPath); ?>/tpl/static/bargain/images/wxnewspic.jpg" id="wxpic" style="width:363px;"  />
		...
		<div class="msgWrap bgfc">
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						<th>&nbsp;</th>
						<td><button type="submit" class="btnGreen" >保存</button>　<a href="<?php echo U('Bargain/index',array('token'=>$token));?>"  class="btnGray vm">取消</a></td>
					</tr>
