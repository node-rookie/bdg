...
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">增加团购商品</a>
</div>
...
<td><?php echo ($hostlist["name"]); if($hostlist["status"] == '2'): ?><br><font color="red">[团购已失败]</font><?php endif; ?></td>
<td><?php echo ($hostlist["title"]); ?></td>
<td><?php echo ($hostlist["price"]); ?></td>
<td><?php if($hostlist["paidnum"] == $hostlist.tgnum): ?><font color="red">团购成功</font><br><?php endif; ?>开团要求：<?php echo ($hostlist["tgnum"]); ?> 人团<br>已经参团：<?php echo ($hostlist["tgs"]); ?> 人</td>
<td>已付款：<?php echo ($hostlist["paidnum"]); ?> 人<br>未付款：<?php echo ($hostlist["unpaidnum"]); ?> 人</td>
...
<td class="norightborder" align="center">
	<a href="<?php echo U('Storenew/grouponrule', array('codeid'=>$hostlist['code'],'token'=>$token,'cid'=>$cid));?>">团购详情</a>
</td>
