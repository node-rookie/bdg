...
<a href="<?php echo U('Voteimg/item_list',array('vote_id'=>$vote_id,'token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回选项列表</a>
</div>

<div class="msgWrap bgfc">
<form class="form" method="post" action="<?php echo U('Voteimg/add_item',array('id'=>$id,'token'=>$token));?>" target="_top">
...
<td><input type="text" name="vote_title" id="vote_title" value="" class="px" style="width:350px;">&nbsp;&nbsp;&nbsp;(不超过15个字母,一个汉字3个字母)</td>
</tr>
<tr>
<th width="120"><span class="red">*</span>图片地址</th>
<td><input type="text" name="vote_img" value='' id="pic1" class="px" style="width:350px;" >
  <a href="###" onclick="upyunPicUpload('pic1',700,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;&nbsp;(图片最佳尺寸700px*500px)</td>
</tr>
<tr>
<th width="120">图片跳转地址：</th>
<td><input type="text" name="jump_url" id="jump_url" value="" class="px" style="width:350px;"><?php if(session('isQcloud') != true): ?><a href="###" onclick="addLink('jump_url',0)" class="a_choose">从功能库添加</a><?php endif; ?>&nbsp;&nbsp;&nbsp;(如果填写,首页点击宝宝图片会跳转到该地址,如果不填则跳转到宝宝详细页)</td>
</tr>
<tr>
  	<th valign="top"><span class="red">*</span>拉票宣言：</th>
  	<td><textarea class="px" id="manifesto" name="manifesto" style="width:643px; height: 100px;"></textarea>
	</td>
</tr>
<tr>
  	<th valign="top"><span class="red">*</span>自我介绍：</th>
  	<td><textarea class="px" id="introduction" name="introduction" style="height: 350px;"></textarea>
	</td>
</tr>
<tr>
<th width="120">票数：</th>
<td><input type="text" name="vote_count" id="vote_count" value="" class="px" style="width:120px;">&nbsp;&nbsp;&nbsp;(可以手动设置选项获得的票数)</td>
</tr>
<tr>
<th width="120">联系方式：</th>
<td><input type="text" name="contact" id="contact" value="" class="px" style="width:120px;">&nbsp;&nbsp;&nbsp;(可以用于通知得奖者)</td>
</tr>
<tr>
<th>&nbsp;</th>
...
<a href="<?php echo U('Voteimg/add_item',array('vote_id'=>$vote_id,'token'=>$token));?>" class="btnGray vm">取消</a>
</td>
</tr>
</tbody>
</table>
