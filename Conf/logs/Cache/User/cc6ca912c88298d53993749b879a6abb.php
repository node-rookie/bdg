...
<TR>
  ...
  <td><input class="radio" type="radio" name="focus" value="1"  <?php if($vo['focus'] == 1): ?>checked<?php endif; ?> > 关注  <input class="radio" type="radio" name="focus" value="0"  <?php if($vo['focus'] == 0): ?>checked<?php endif; ?>> 注册</td>
</TR>
<TR>
  <th valign="top">无粉丝信息：</th>
  <td><input class="radio" type="radio" name="needreg" value="1"  <?php if($vo['needreg'] == 1): ?>checked<?php endif; ?> > 注册  <input class="radio" type="radio" name="needreg" value="0"  <?php if($vo['needreg'] == 0): ?>checked<?php endif; ?>> 不注册
  <br><span class='red'>如果粉丝没有填写手机号会提示注册，方便发奖。</span></td>
</TR>
<tr>
<th>&nbsp;</th>
