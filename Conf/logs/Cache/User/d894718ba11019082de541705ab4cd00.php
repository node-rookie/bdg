...
<form class="form" method="post"   action="<?php echo U('Unitary/doupdate',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data" >
<input type="hidden" name="id" value="<?php echo ($unitary["id"]); ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo ($staticPath); ?>/tpl/static/unitary/css/cymain.css" />
<div class="content">
	<div class="cLineB" id="ooo">
		<h4 class="left">修改【<?php echo ($unitary["name"]); ?>】</h4>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
			<tbody>
				<tr>
					...
					<td>
						<input type="input" class="px" id="keyword" value="<?php echo ($unitary["keyword"]); ?>" name="keyword" style="width:400px" />
						<br/>
						<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
					</td>
					<td rowspan="999" valign="top">
						<div style="margin-left:20px">
							<?php if($unitary['wxpic'] == null){?>
							<img id="wxpic_src" src="<?php echo ($unitary["wxpic"]); ?>" width="373px" />
							<?php }else{?>
							<img id="wxpic_src" src="<?php echo ($unitary["wxpic"]); ?>" width="373px" />
							<?php }?>
							<br/>
							<input class="px"  name="wxpic" value="<?php echo ($unitary["wxpic"]); ?>" id="wxpic" style="width:363px;"  />
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="name" value="<?php echo ($unitary["name"]); ?>" name="name" style="width:400px" />
						<br/>
						请不要多于50字!
					</td>
				</tr>
				<tr>
					...
					<td>
						<textarea  class="px" id="wxinfo" name="wxinfo"  style="width:400px; height:125px" ><?php echo ($unitary["wxinfo"]); ?></textarea>
						<br/>
						换行请输入
						&lt;br&gt;
					</td>
				...
				<tr>
					...
					<td>
						<?php if(($pay_count == 0) and ($unitary["state"] == 0)): ?>&#165;<input type="input" class="px" id="price" value="<?php echo ($unitary["price"]); ?>" name="price" style="width:50px" />元
						<br/>
						不能有小数，活动开始后不能修改
						<?php else: ?>
						&#165;<?php echo ($unitary["price"]); ?>元
						<input type="hidden" class="px" id="price" value="<?php echo ($unitary["price"]); ?>" name="price" style="width:50px" /><?php endif; ?>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="type" id="type">
							...
							<option value="1" <?php if($unitary['type'] == 1){echo "selected";}?>>手机数码</option>
							<option value="2" <?php if($unitary['type'] == 2){echo "selected";}?>>电脑办公</option>
							<option value="3" <?php if($unitary['type'] == 3){echo "selected";}?>>家用电器</option>
							<option value="4" <?php if($unitary['type'] == 4){echo "selected";}?>>化妆个护</option>
							<option value="5" <?php if($unitary['type'] == 5){echo "selected";}?>>钟表首饰</option>
							<option value="9999" <?php if($unitary['type'] == 9999){echo "selected";}?>>其他商品</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						<input type="input" class="px" id="logopic"  name="logopic" value="<?php echo ($unitary["logopic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fistpic"  name="fistpic" value="<?php echo ($unitary["fistpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="secondpic"  name="secondpic" value="<?php echo ($unitary["secondpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="thirdpic"  name="thirdpic" value="<?php echo ($unitary["thirdpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fourpic"  name="fourpic" value="<?php echo ($unitary["fourpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="fivepic"  name="fivepic" value="<?php echo ($unitary["fivepic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td>
						<input type="input" class="px" id="sixpic"  name="sixpic" value="<?php echo ($unitary["sixpic"]); ?>"  style="width:250px"/>
				...
				<tr>
					...
					<td> 
						<input type="input" class="px" id="min" value="<?php echo ($time_min); ?>" name="min" style="width:30px" /> 分钟
						<br/>
				...
				<!-- <tr>
					...
					<td><input class="radio" type="radio" name="wxregister" value="1" <?php if($unitary['wxregister'] == 1){echo "checked";}?>> 关注  <input class="radio" type="radio" name="wxregister" value="0"  <?php if($unitary['wxregister'] == 0){echo "checked";}?>> 注册 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（非关注用户参加活动的处理方式）
				</td>
				</tr>
				<tr>
					<th valign="top">无粉丝信息：</th>
					<td><input class="radio" type="radio" name="register" value="1" <?php if($unitary['register'] == 1){echo "checked";}?>> 注册  <input class="radio" type="radio" name="register" value="0"  <?php if($unitary['register'] == 0){echo "checked";}?>> 不注册 &nbsp;&nbsp;&nbsp;（没有粉丝信息参加活动的处理方式）</td>
				</tr> -->
				<!-- <tr>
					<th valign="top">商品活动状态：</th>
					<td><input class="radio" type="radio" name="state" value="1" <?php if($unitary['state'] == 1){echo "checked";}?>> 开始  <input class="radio" type="radio" name="state" value="0"  <?php if($unitary['state'] == 0){echo "checked";}?>> 关闭 </td>
				</tr> -->
				<tr>
					<th>&nbsp;</th>
