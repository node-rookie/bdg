...
<script language="javascript" type="text/javascript" src="<?php echo ($staticPath); ?>/tpl/static/bargain/js/DatePicker/WdatePicker.js"></script>
...
<form class="form" method="post"   action="<?php echo U('Bargain/doupdate',array('token'=>$token));?>"  target="_top" enctype="multipart/form-data" >
	<div class="content">
		<div class="cLineB">
		...
		<div class="cLineB">
			...
			<a href="<?php echo U('Bargain/index',array('token'=>$token));?>"  class="right btnGreen" >返回</a>
		</div>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="keyword" value="<?php echo ($bargain["keyword"]); ?>" name="keyword" style="width:400px" />
							<br/>
							<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
						</td>
						<td rowspan="999" valign="top">
							<div style="margin-left:20px">
								<img id="wxpic_src" src="<?php echo ($bargain["wxpic"]); ?>" width="373px" >
								<br/>
								<input class="px"  name="wxpic" value="<?php echo ($bargain["wxpic"]); ?>" id="wxpic" style="width:363px;"  />
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="name" value="<?php echo ($bargain["name"]); ?>" name="name" style="width:400px" />
							<br/>
							请不要多于50字!
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="wxtitle" value="<?php echo ($bargain["wxtitle"]); ?>" name="wxtitle" style="width:400px" />
							<br/>
							请不要多于50字!
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<textarea  class="px" id="wxinfo" name="wxinfo"  style="width:400px; height:125px" ><?php echo ($bargain["wxinfo"]); ?></textarea>
							<br/>
							换行请输入
							&lt;br&gt;
						</td>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="starttime" value="<?php echo ($bargain["starttime"]); ?>" name="starttime" style="width:100px"/>&nbsp;单位（小时）
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="original" value="<?php echo ($bargain["original"]); ?>" name="original" style="width:100px" />&nbsp;原价不能低于底价，单位（元）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="minimum" value="<?php echo ($bargain["minimum"]); ?>" name="minimum" style="width:100px" />&nbsp;底价不能高于原价，单位（元）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							共&nbsp;<input type="number" class="px" id="dao" value="<?php echo ($bargain["dao"]); ?>" name="dao" style="width:100px" />&nbsp;刀砍至底价&nbsp;&nbsp;（注：总刀数要大于前N刀的刀数）
						</td>
					</tr>
					...
					<tr>
						<th valign="top"></th>
						<td>
							前&nbsp;<input type="number" class="px" id="qdao" value="<?php echo ($bargain["qdao"]); ?>" name="qdao" style="width:100px" />&nbsp;刀，砍掉&nbsp;<input type="number" class="px" id="qprice" value="<?php echo ($bargain["qprice"]); ?>" name="qprice" style="width:100px" />&nbsp;元&nbsp;&nbsp;（注：前N刀砍掉的钱数要小于原价减去底价的钱数）
						</td>
					</tr>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						<th valign="top"><span class="red">*</span>商品原价：</th>
						<td>
							<input type="hidden" class="px" id="original" value="<?php echo ($bargain["original"]); ?>" name="original" style="width:100px" /><?php echo ($bargain["original"]); ?>&nbsp;原价不能低于底价，单位（元）
						</td>
					</tr>
					...
					<tr>
						<th valign="top"><span class="red">*</span>商品底价：</th>
						<td>
							<input type="hidden" class="px" id="minimum" value="<?php echo ($bargain["minimum"]); ?>" name="minimum" style="width:100px" /><?php echo ($bargain["minimum"]); ?>&nbsp;底价不能高于原价，单位（元）
						</td>
					</tr>
					...
					<tr>
						<th valign="top"><span class="red">*</span>砍价力度：</th>
						<td>
							共&nbsp;<input type="hidden" class="px" id="dao" value="<?php echo ($bargain["dao"]); ?>" name="dao" style="width:100px" /><?php echo ($bargain["dao"]); ?>&nbsp;刀砍至底价&nbsp;&nbsp;（注：总刀数要大于前N刀的刀数）
						</td>
					</tr>
					...
					<tr>
						<th valign="top"></th>
						<td>
							前&nbsp;<input type="hidden" class="px" id="qdao" value="<?php echo ($bargain["qdao"]); ?>" name="qdao" style="width:100px" /><?php echo ($bargain["qdao"]); ?>&nbsp;刀，砍掉&nbsp;<input type="hidden" class="px" id="qprice" value="<?php echo ($bargain["qprice"]); ?>" name="qprice" style="width:100px" /><?php echo ($bargain["qprice"]); ?>&nbsp;元&nbsp;&nbsp;（注：前N刀砍掉的钱数要小于原价减去底价的钱数）
						</td>
					</tr>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="inventory" value="<?php echo ($bargain["inventory"]); ?>" name="inventory" style="width:100px" />&nbsp;只能为正整数
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logoimg1"  name="logoimg1" value="<?php echo ($bargain["logoimg1"]); ?>"  style="width:250px"/>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logourl1" value="<?php echo ($bargain["logourl1"]); ?>" name="logourl1" style="width:400px" /><a href="###" onclick="addLink('logourl1',0)" class="a_choose">从功能库添加</a>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logoimg2"  name="logoimg2" value="<?php echo ($bargain["logoimg2"]); ?>"  style="width:250px"/>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logourl2" value="<?php echo ($bargain["logourl2"]); ?>" name="logourl2" style="width:400px" /><a href="###" onclick="addLink('logourl2',0)" class="a_choose">从功能库添加</a>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logoimg3"  name="logoimg3" value="<?php echo ($bargain["logoimg3"]); ?>"  style="width:250px"/>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="logourl3" value="<?php echo ($bargain["logourl3"]); ?>" name="logourl3" style="width:400px" /><a href="###" onclick="addLink('logourl3',0)" class="a_choose">从功能库添加</a>
						</td>
					</tr>
					
					<tr>
						<th valign="top"><label for="info">商品详情：</label></th>
						<td><textarea name="info" id="info"  rows="5" style="width:590px;height:360px"><?php echo ($bargain["info"]); ?></textarea></td>
					</tr>
					
					<tr>
						<th valign="top"><label for="guize">活动规则：</label></th>
						<td><textarea name="guize" id="guize"  rows="5" style="width:590px;height:360px"><?php echo ($bargain["guize"]); ?></textarea></td>
					</tr>
					
					<tr>
						<th>&nbsp;</th>
						<td>
							<input type="hidden" name="pigcms_id" value="<?php echo ($bargain["pigcms_id"]); ?>"/>
							<button type="submit" class="btnGreen" >保存</button>　<a href="<?php echo U('Bargain/index',array('token'=>$token));?>"  class="btnGray vm">取消</a>
						</td>
					</tr>
