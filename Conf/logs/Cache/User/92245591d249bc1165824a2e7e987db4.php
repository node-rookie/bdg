...
<div class="cLineB">
  <h4>奖品清单</h4>
  <a href="<?php echo U('Scene/index',array('token'=>$token));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
 </div>

<div class="msgWrap form">
<div class="cLineC" style="line-height: 32px;">
<a class="btnGrayS vm bigbtn" href="<?php echo U('Scene/prize_set',array('token'=>$token,'sceneid'=>$sceneid));?>">添加奖品</a>
</div>
...
<thead>
<tr>
<th style=" width:100px;">奖项</th>
<th style=" width:180px;">奖品图片</th>
<th style=" width:180px;">奖品名称</th>             
...
<td><img width="75px" height="50px" src="<?php echo ($list["pic"]); ?>" alt="<?php echo ($list["pname"]); ?>"></td>
<td><?php echo ($list["pname"]); ?></td>
<td><?php echo ($list["num"]); ?></td>
<td><?php echo ($list["sort"]); ?></td>
<td>

  <a href="<?php echo U('Scene/prizeRecords',array('pid'=>$list['id'],'sceneid'=>$list['sceneid'],'token'=>$_SESSION['token']));?>">中奖名单</a> 
  |
  <a href="<?php echo U('Scene/prize_set',array('token'=>$token,'sceneid'=>$list['sceneid'],'pid'=>$list['id']));?>">修改</a>
  |
  <a href="<?php echo U('Scene/prize_del',array('token'=>$token,'sceneid'=>$list['sceneid'],'pid'=>$list['id']));?>" onclick="return confirm('确定要删除吗?');">删除</a>
