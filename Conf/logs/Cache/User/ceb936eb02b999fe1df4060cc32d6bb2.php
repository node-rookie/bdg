...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
        <div class="content">
<div class="cLineB">
<h4 class="left">订单管理（<a href="<?php echo U('Storenew/orders',array('token'=>$token,'handled'=>0));?>">未处理订单<span style="color:#f00"><?php echo ($unhandledCount); ?></span>个</a>） (<?php echo ($page); ?>) </h4>
...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Storenew/cats',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btnGreen" style="margin-top:-27px">返回上</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
...
<div class="tab">
<ul>
	<li class="current tabli" id="tab2"><a href="<?php echo U('Storenew/orders',array('token'=>$token));?>">商城订单</a></li>
	<li class="tabli" id="tab2"><a href="<?php echo U('Storenew/jingpaiorders',array('token'=>$token));?>">竞拍订单</a></li>
...
<a href="<?php echo U('Storenew/orders', array('token' => $token, 'cid' => $cid,'paid'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已付款订单</a>
<a href="<?php echo U('Storenew/orders', array('token' => $token, 'cid' => $cid,'paid'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未付款订单</a>
<a href="<?php echo U('Storenew/orders', array('token' => $token, 'cid' => $cid,'sent'=>1));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">已发货订单</a>
<a href="<?php echo U('Storenew/orders', array('token' => $token, 'cid' => $cid,'sent'=>0));?>" title="已付款订单" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">未发货订单</a>
<a href="<?php echo U('Storenew/export',array('token'=>$token,'cid'=>$cid));?>" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">导出订单记录</a>
</div>

<div class="pageNavigator right"> 
<a href="<?php echo U('Storenew/index', array('token' => $token, 'cid' => $cid));?>" title="商城设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">商品管理</a>
<div class="clr"></div>
</div>
...
function showIntroDetail(id){
	art.dialog.open('<?php echo U('Storenew/orderInfo',array('token'=>$token,'dining'=>$isDining));?>&id='+id,{lock:false,title:'订单详情',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87, close: function(){location.reload();}});
}
</script>
</div>
<div class="cLine">
