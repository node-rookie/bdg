                    ...
                    <?php if($renew == ''): ?><li class="tuPian" id="ren">
                        ...
                        <li class="tuPian" id="ren">
                            <a href="javascript:void(0)">
                                ...
                                <p class="xiaoZhu clr">微信签到新版</p>
                                <p class="weizhi clr"></p>
                                <p class="hengXian clr"></p>
                                <p class="sixth clr">2013年7月30日</p>  
                            </a>
                        </li> 
                        <li class="tuPian" id="ren">
                            <a href="javascript:void(0)">
                                ...
                                <p class="weizhi clr"></p>
                                <p class="hengXian clr"></p>
                                <p class="sixth clr">2015年7月20日</p>  
                            </a>
                        </li>  
                        <li class="tuPian" id="ren">
                            <a href="javascript:void(0)">
                                ...
                                <p class="weizhi clr"></p>
                                <p class="hengXian clr"></p>
                                <p class="sixth clr">2015年7月14日</p>  
                            </a>
                        </li>   
                        <li class="tuPian" id="ren">
                            <a href="javascript:void(0)">
