	...
	<div class="biaotilan clr">
        <div class="shang clr">
            <div class="zhongJian clr">
                <div class="zLeft clr">欢迎使用<?php echo ($f_siteName); ?>移动互联网会员管理与营销系统!</div>
		...
		<div class="content clr">
        	<div class="congtS clr">
                ...
                <div class="shangRt clr">
                	<p class="oneth clr"> <a href="<?php echo ($f_siteUrl); ?>"><?php echo ($f_siteName); ?>移动互联网会员管理与营销系统</a></p>
                    <p>»</p>
            ...
            <div class="congtX clr">
                ...
                <p class="first clr">第一步、在<?php echo ($f_siteName); ?>移动互联网会员管理与营销系统绑定你的微信公众号。</p>
                <ul>
                	<li class="suojin clr">1、注册并登录<a href="<?php echo U('Index/login');?>"><?php echo ($f_siteName); ?>移动互联网会员管理与营销系统接口平台</a></li>
        ...
        <div class="footer clr" style="padding-bottom:20px;">
        	<div class="last clr">
            	<P style="padding-bottom: 0px;">春哥微信营销系统© <?php echo ($time); ?> <?php echo C('server_topdomain');?>   <?php echo C('ipc');?></P>
            </div>
        </div>
