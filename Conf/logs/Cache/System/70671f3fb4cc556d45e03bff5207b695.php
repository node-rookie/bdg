...
<div class="box">
    ...
    <p class="black"><strong>您的程序版本为：</strong><font color="red"><?php echo ($vername); ?> v<?php echo ($ver); ?>&nbsp;&nbsp;&nbsp;<a href="http://www.dede168.com/" target="_blank"><strong>检查更新</strong></a></font>    </p>
    <p><a href="?g=System&m=System&a=repairTable" class="blue" style="color:green">系统反应慢，关键词没响应，请点击这里删除一下缓存</a></p>
    </div>
     <ul class="myinfo">
        <li>
          <p class="black">dede168源码网致力于免费分享各种精品资源！</p> 
        </li>
	</ul>
    </div>
</div>
