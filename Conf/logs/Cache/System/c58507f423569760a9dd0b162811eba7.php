...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="alist">
	  <tr>
		...
		<td width="200">url</td>
		<td >宣传图</td>
		<td width="130">选中时图片</td>
		<td width="130">未选中时图片</td>
	    ...
	    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td ><img src="<?php echo ($vo["imgs"]); ?>" style="height:150px"></td>
				<td ><img src="<?php echo ($vo["img_x"]); ?>"/></td>
				<td ><img src="<?php echo ($vo["img_w"]); ?>"/></td>
				...
				<td align='center'>
					<a href="<?php echo U('Renew/edit/',array('id'=>$vo['id'],'pid'=>$pid));?>">修改</a>
					| <a href="javascript:void(0)" onclick="return confirmurl('<?php echo U('Renew/del/',array('id'=>$vo['id'],'pid'=>$pid));?>','确定删除该信息吗?')">删除</a>
				</td>
