...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="pwd_email_title" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('pwd_email_title');?></textarea><span>&nbsp;&nbsp;</span>
    </tr>	
	<tr> 
      <td  height="48" align="right"><strong>密码找回主题：</strong></td>
      <td><textarea	 type="text" name="pwd_email_content" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('pwd_email_content');?></textarea><span>&nbsp;&nbsp;</span>
    </tr>
