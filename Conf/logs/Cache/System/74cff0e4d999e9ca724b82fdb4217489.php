...
<?php if(($info["id"]) > "0"): ?><form action="<?php echo U('Case/upsaves');?>" method="post" name="form" enctype="multipart/form-data" id="myform">
			<input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
		<?php else: ?>
			<form action="<?php echo U('Case/adds');?>" method="post" name="form" enctype="multipart/form-data" id="myform"><?php endif; ?>
