...
<head>
	...
	<meta name="keywords" content="<?php echo ($f_siteName); ?>-后台管理系统（春哥技术博客出品）" />
	<meta name="description" content="<?php echo ($f_siteName); ?>-后台管理系统（春哥技术博客出品）" />
				...
				<div id="header">
					<div class="top">
						<a href="/index.php?g=System&m=System&a=index" class="logo" title="首页">首页</a>
						 <div class="login">
							<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用CgtblogSystem！</li>	
					...
					<div class="topnav"><p><a href="#" id="togglemenu">隐藏菜单</a>&nbsp;<span class="fr"><a href="http://www.dede168.com" target="_blank" style="color:red">程序不断升级中，更多升级请访问：dede168源码网-www.dede168.com</a></span>                    					</div>
					<div class="fr"></div>
				</div>
				<i class="tico"></i>
			</td>
		...
		<tr>
			<td>
				<div id="footer">
					...
					<p class="fr"><a href="http://www.dede168.com" target="_blank">程序由【dede168源码网-www.dede168.com】提供</a></p>
				</div>
			</td>
		</tr>
	</table>
