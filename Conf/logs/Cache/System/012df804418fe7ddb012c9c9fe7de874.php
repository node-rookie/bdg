...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="alist">
	  <tr>
	    ...
	    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td ><img src="<?php echo ($vo["timg"]); ?>"/></td>
				<td ><img src="<?php echo ($vo["img"]); ?>" style="width:100px"/></td>
				<td align='center'><?php if(($vo["status"]) == "1"): ?><font color="red">√</font><?php else: ?><font color="blue">×</font><?php endif; ?> 
				</td>
				<td align='center'>
					<a href="<?php echo U('Case/edit/',array('id'=>$vo['id'],'pid'=>$pid));?>">修改</a>
					| <a href="javascript:void(0)" onclick="return confirmurl('<?php echo U('Case/del/',array('id'=>$vo['id'],'pid'=>$pid));?>','确定删除该案例吗?')">删除</a>
				</td>
