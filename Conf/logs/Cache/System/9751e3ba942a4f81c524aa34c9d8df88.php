...
<?php if(($info["id"]) > "0"): ?><form action="<?php echo U('Case/upsave');?>" method="post" name="form" enctype="multipart/form-data" id="myform">
		...
		<?php else: ?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					<td height="48" align="right"><strong>案例分类：</strong></td>
					<td colspan="3" class="lt">
						<select style="height:25px;width:200px" name="class" id="sele"> 
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" class="ipt" id="pic2" name="timg" value="<?php echo ($info["timg"]); ?>" required/> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',150,150,'<?php echo ($token); ?>')">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>
						<span style="color:red">&nbsp;&nbsp;&nbsp;建议尺寸：102x102</span>
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>图片：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" class="ipt" id="pic" name="img" value="<?php echo ($info["img"]); ?>" required/> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>
						<span style="color:red">&nbsp;&nbsp;&nbsp;建议尺寸：212x336</span>
					</td>
				</tr>
				<tr>
