...
<title>测测你的时间去哪儿了</title>
<meta name="keywords" content="测测你的时间去哪儿了" />
<meta name="description" content="测测你的时间去哪儿了" />
	...
	$.post("do.php", { name: $("#name").val()},function(data){
		...
		$("#startbtn").rotate({
			...
			callback: function(){
				...
				var infos="'"+$("#name").val()+"'的时间都去"+info[data]+"了。";
				$(document).attr('title',infos+"测测你的时间去哪儿了");
