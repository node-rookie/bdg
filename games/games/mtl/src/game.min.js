	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://www.v918.cn/vgames",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://www.v918.cn/vgames";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.v918.cn/vgames";
y.url = function() {
	return "http://www.v918.cn/vgames?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.v918.cn/vgames/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("微时代管家—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("微时代管家", "Arial", 12);
