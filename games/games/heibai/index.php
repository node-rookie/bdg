...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script language="javascript" type="text/javascript" src="http://www.v918.cn/vgames/games/heibai/play68.js"></script>
		<script data-main="js/doNotTouchWhite" src="http://www.v918.cn/vgames/games/heibai/require.js"></script>
		<title>看谁踩方块多</title>
		<style type="text/css">
			body {
				margin:0px;
	...
	<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="doNotTouchWhite" src="http://www.v918.cn/vgames/games/heibai/doNotTouchWhite.js"></script></head>
	<body>
		...
		<!--play68 init-->
		<link type="text/css" rel="stylesheet" href="http://www.v918.cn/vgames/games/heibai/sidebar.css">
		<style type="text/css">
		<!--
		#play68box {
			top: 5%;
