...
;~function(bt){
	...
	bt.URL = {
		root: "http://www.v918.cn/vgames"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://www.v918.cn/vgames";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd";
		}
...
;~function(bt){
	...
	function ask(cb){
		if(confirm('关注"微时代管家"微信，就可以收藏这个游戏哦！')){
