...
<script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/games/qie/img/icon.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/qie",
		        "tTitle": "打企鹅-软灵通",
		        "tContent": "打企鹅-软灵通微信号：v918_cn"
		};
		...
		<div id=share style="display: none">
			<img width=100% src="http://www.v918.cn/vgames/games/qie/share.png"
				style="position: fixed; z-index: 9999; top: 0; left: 0; display: "
				ontouchstart="document.getElementById('share').style.display='none';" />
		</div>
		<div style="display: none;">
			<script type="text/javascript">
            var myData = { gameid: "qie" };
			window.shareData.timeLineLink = "http://www.v918.cn/vgames/games/qie/index.html";
			...
			function onShareComplete(res) {
                if (localStorage.myuid && myData.score != undefined) {
                    setTimeout(function(){
                        if (confirm("要将成绩提交到迪欧手工排行榜吗？")) {
                            window.location = "http://sanduo.sinaapp.com/games/qie/index.html";
                        }
                        else {
