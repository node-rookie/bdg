...
//resultPath='http://game.9g.com/cscg/game.html?result='+resrand;
resultPath='http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd'+resrand;
var mebtnopenurl = 'http://www.v918.cn/vgames/games/';
window.shareData = {
    "imgUrl": "http://www.v918.cn/vgames/icon/cggl.jpg",
    "timeLineLink": "http://www.v918.cn/vgames/games/ccgl",
...
<div class="box current" id="toptop">
  <ul>
    ...
    <a href="#" onclick="clickMore();" style="display: block;margin-top:80px;text-decoration:none"><img src="images/more.jpg" width="100%"></a>
...
<div class="question ">
  ...
  <a href="javascript:void(0)">返回上一题</a>
     ...
     <a href="#" onclick="clickMore();" style="text-decoration:none;font-size: 25px;color: #f00;font-weight: bold;display: block;margin-top:30px;">更多测试</a>
      ...
      <a style="font-size: 25px;color: #f00;font-weight: bold;display: block;margin-top:20px;text-decoration:none" href="http://www.v918.cn/vgames/games/gzh">狙击手专用眼力测试，你能闯到第几关？</a> --&gt;
...
<div class="question ">
  ...
  <a href="javascript:void(0)">返回上一题</a>
    ...
    <a href="#" onclick="clickMore();" style="display: block;margin-top:60px;text-decoration:none"><img src="images/more.jpg" width="100%"></a>
...
<div class="question ">
  ...
  <ul>
    <li data-score="1" onclick="mask();">
     ...
     <div class="title-sub">
        <a href="http://www.v918.cn/vgames/games/cggl/" style="text-decoration:none"><button style="font-size:25px">重新测试</button></a>
      </div>
     <a href="#" onclick="clickMore();" style="text-decoration:none;font-size: 25px;color: #f00;font-weight: bold;display: block;margin-top:30px;">更多测试</a>
...
<div class="result">
    <div class="title">
      ...
      <div class="title-sub">
        <a href="http://www.v918.cn/vgames/games/cggl/" style="text-decoration:none"><button style="font-size:25px">测测我的出轨率</button></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="clickMore();" style="text-decoration:none"><button style="font-size:25px">更多测试</button></a>
      </div>
     <a href="#" onclick="clickMore();" style="text-decoration:none;font-size: 25px;color: #f00;font-weight: bold;display: block;margin-top:30px;">更多测试</a>
...
<div style="margin-top:5px;" id="bai" align="center">
  <div style="display: inline;float: center;"><br>
</div>
</div>
<div id="sharediv" style="display: none">
			<img src="images/share.png" style="position: fixed; z-index: 9999; top: 0; left: 0; display: " ontouchstart="document.getElementById('sharediv').style.display='none';" width="100%">
		</div>
