...
<body style="padding:0; margin: 0; background: #000;">
	...
	<script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/icon/flnu.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/flnu/index.html",
		        "tTitle": "粉蓝男女-软灵通",
		        "tContent": "粉蓝男女-软灵通"
		};
		...
		function clickMore(){
			if((window.location+"").indexOf("f=zf",1)>0){
				window.location = "http://www.v918.cn/vgames/games/flnu/index.html";
			 }
			 else{
				goHome();
			 }
		...
		<div id=share style="display: none">
            ...
            var myData = { gameid: "flnu" };
			 // var domain = ["oixm.cn", "hiemma.cn", "peagame.net"][parseInt(Math.random() * 3)];
			window.shareData.timeLineLink = "http://www.v918.cn/vgames/games/flnu/index.html";
			function dp_submitScore(score){
						myData.score = parseInt(score);
						myData.scoreName ="桃花运指数"+score+"分";		
						document.title = window.shareData.tTitle ="我的桃花运指数是"+score+"分,小伙伴们快来试试你们的花桃运吧！";
			}
