...
<canvas id="stage" >
		...
		dataForWeixin = {
			...
			"url": "http://www.v918.cn/vgames/games/jyfy/",
		        "tTitle": "监狱风云-微时代游戏",
		...
		document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
		    ...
		    WeixinJSBridge.on('menu:share:timeline', function(argv) {
		        WeixinJSBridge.invoke('shareTimeline', {
				 ...
				 setTimeout(function () {location.href = "http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd";}, 1500); 
		    });
		}, false);
		</script>
