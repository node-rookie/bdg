...
<body onLoad="init()">
    ...
    <script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/icon/sqs.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/sqs",
		        "tTitle": "神枪手-软灵通",
		...
		function clickMore(){
			 if((window.location+"").indexOf("zf",1)>0){
			 	window.location = "http://www.v918.cn/vgames/games/sqs";
			  }
			  else{
			 	goHome();
			  }
		...
		<div id=share style="display: none">
			<img width=100% src="http://www.v918.cn/vgames/games/sqs/share.png"
				style="position: fixed; z-index: 9999; top: 0; left: 0; display: "
				ontouchstart="document.getElementById('share').style.display='none';" />
		</div>
		<div style="display: none;">
			<script type="text/javascript">
            var myData = { gameid: "sqs" };
