...
<script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/games/jssjm/icon.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/jssjm/index.html",
		        "tTitle": "激射神经猫-软灵通",
		        "tContent": "激射神经猫-软灵通"
		};
		...
		<div id=share style="display: none">
			<img width=100% src="http://www.v918.cn/vgames/games/jssjm/share.png"
		...
		<div style="display: none;">
			...
			window.shareData.timeLineLink = "http://www.v918.cn/vgames/games/jssjm/index.html";
...
if (/android|linux/i.test(navigator.userAgent)) {
	if(getParameter('f')=='zf'){
		setTimeout(function(){
			$("<div style='position:absolute;left:0px;bottom:0px;'><a href='http://www.v918.cn/vgames/games/dtcq/game.html'><img src='http://www.v918.cn/vgames/games/dtcq/ad2.jpg' style='width: 100%;'/></a></div>").appendTo($("#gameDiv"));
		}, 3000);
	}
}
</script>
