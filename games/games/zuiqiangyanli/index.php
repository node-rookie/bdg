...
<head>
	...
	var moreGamesLocation = 'http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd';
	function play68_init() {		updateShare(0);}
	function updateShare(bestScore) {
		imgUrl = '1.png';
		var domains = ['http://www.v918.cn/vgames/'];
		var domain = domains[new Date().getTime()%4];lineLink = 'http://www.v918.cn/vgames/zuiqiangyanli/';descContent = "考考你的眼力！你的眼睛跟得上吗？";updateShareScore(bestScore);appid = '';
	}	
...
<script type="text/javascript" src="www.v918.cn/vgames" charset="UTF-8"></script>
</head>
  ...
  <body class="os-windows osv-6_1 osmv-6" onorientationchange="orentationChanged()">    
    <DIV class="main">
	 ...
	 <div  style="position:relative; display: block; margin: 0px auto;bottom:120px;z-index:20000">
	 	<a style="font-size: 15px;color: #f00;font-weight: bold;display: block;height: 30px;line-height: 30px;" href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd">关注我们</a><br/>
	 	<a style="font-size: 15px;color: #f00;font-weight: bold;display: block;height: 30px;line-height: 30px;" href="http://www.v918.cn/vgames/">更多游戏</a>
	 </div>
