...
<body> 
    ...
    <script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/icon/zzs.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/zzs",
		        "tTitle": "涨姿势-软灵通",
		        "tContent": "涨姿势-软灵通"
		};
		...
		function clickMore(){
			 if((window.location+"").indexOf("zf",1)>0){
			 	window.location = "http://www.v918.cn/vgames/games/zzs";
			  }
			  else{
			 	goHome();
			  }
		...
		function dp_share(){
			document.title ="我撸了"+myData.step+"发 涨了"+myData.score+"新姿势！"+myData.percent+"%对手被我击败，你行嘛？";
		...
		<div id=share style="display: none">
			<img width=100% src="http://www.v918.cn/vgames/games/zzs/share.png"
				style="position: fixed; z-index: 9999; top: 0; left: 0; display: "
				ontouchstart="document.getElementById('share').style.display='none';" />
		</div>
		<div style="display: none;">
			<script type="text/javascript">
            var myData = { gameid: "zzs" };
			var domain = ["oixm.cn", "hiemma.cn", "peagame.net"][parseInt(Math.random() * 3)];
			window.shareData.timeLineLink = "http://www.v918.cn/vgames/games/zzs";
			function dp_submitScore(score,step,percent){
				myData.score = parseInt(score);
				myData.step = step;
				myData.percent = percent;
				myData.scoreName = "涨了"+score+"个新姿势";
				if(score>1){
					if (confirm("你撸了"+step+"发,涨了"+score+"个新姿势！征服了"+percent+"%对手，让小伙伴们膜拜你吧！")){
						dp_share();
					}
				}
			}
