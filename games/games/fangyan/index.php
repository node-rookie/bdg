    ...
    <div id="content">
        ...
        <div class="text-center header">
            ...
            <p>
                ...
                <span style="padding:4px;background-color: #000;">已有<font color="#FFCC00"><script src="http://news.0579.cn/NewsStatic/Default.aspx?NID=2014072610" charset='utf-8' language="JavaScript" type="text/javascript"></script></font>人参与测试</span>
            </div>
            <!-- E header -->
            <div id="bd" class="panel">
                <div id="panel1" class="panel-body">
                    ...
                    <dl>
                        <dd>
                            新疆话四级太简单、六级话有点难，八级完全不会啊有木有？新疆的小伙伴们都自卑了！——软灵通</dd>
                    </dl>
                    <div class="buttons">
                    ...
                    <div class="buttons" style="margin-top: 10px;">
                        <a href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd" id="weixinfollowlink2" class="btn btn-lg btn-danger" style="width: 100%;
                            background: #0e6796; border-color: #0e6796;">微信关注--软灵通</strong></a>
                    </div>
                    </form>
                </div>
                <!-- E panel-body -->
                <div id="panel2" class="panel-body js_answer" style="display: none;">
                    ...
                    <div class="form-group avatar text-center">
                        ...
                        <a href="javascript:void(0)" class="img-circle" name="1"><span style="float: left;
                            text-align: center; width: 100%; padding-top: 18px;"><img src="ks.jpg"></span> </a>
                    </div>
                    <dl><dd>1.““一头囊哈去”的意思是</dd></dl>
            ...
            <div id="panel3" class="panel-body js_result" data-id="0" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                            哇哦！能考出如此惊天地、泣鬼神的分数，可见本人是多么的不一般。“24K的新疆话白痴”这个称号非你莫属了。（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
            ...
            <div id="panel3" class="panel-body js_result" data-id="1" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                            您一定不是本地人吧，不过您已获得新疆话金种子称号！（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
            ...
            <div id="panel3" class="panel-body js_result" data-id="2" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                              你的新疆话已经相当不错了，虽然没有及格，不过没关系、抽个空泡个新疆妞/新疆帅哥，相信你会拿走你该得的满分！（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
            ...
            <div id="panel3" class="panel-body js_result" data-id="3" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                              您已获得新疆羊肉串形象代言人特权！抽空去爬爬红山切，相信你的新疆口语会更上一层楼的哟~（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
            ...
            <div id="panel3" class="panel-body js_result" data-id="4" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                             哈哈哈，是不是被难倒了，没有拿到满分也正常，谁让我们的八级测试那么难呢~努力练习你的新疆话，成为南阳的骄傲吧！（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
            ...
            <div id="panel3" class="panel-body js_result" data-id="5" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                             噗~~竟然拿到了这么高的分数，看来你是有备而来！如此流利的新疆话，令人钦佩！（分享到朋友圈可见具体分数）</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
            ...
            <div id="panel3" class="panel-body js_result" data-id="6" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <p>
                             新疆话、是你居家旅行，升官发财，发家致富，打情骂俏之必备利器！本次八级测试，你成功过关！速度分享到朋友圈晒下你的得分吧！</p>
                    </dd>
                </dl>
                <div class="buttons">
                    <a href="javascript:void(0)" class="btn btn-lg btn-success" style="width: 100%" onclick="$(&#39;#mcover&#39;).show()">
...
var tScore = 0;
var dataForWeixin={
    img:    "http://www.v918.cn/vgames/games/fangyan/20140725ywh1200.jpg",
    url:    "http://www.v918.cn/vgames/games/fangyan/index.html",
    title:  "我在2014年最难新疆话专业八级考试中得了 ",
    desc:   "2014年新疆话专业八级考试",
};
function next(t){
...
function report(link, action_type){
	...
	query_obj['action_link'] = 'http://www.v918.cn/vgames/games/fangyan/index.html';
...
$(function(){
    ...
    <div id="popup-1" class="tip" style="display: none;">
        <div>
            ...
            <div class="row text-center">
                <a href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd" class="btn btn-danger col-sm-12 btn-lg" id="weixinfollowlink">微信关注：软灵通</a>
            </div>
            <!-- E discuss -->
        </div>
    </div>
    ...
    <div id="follow" class="well" style="display: none;">
        ...
        <div class="row text-center">
            <a href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd" class="btn btn-danger col-sm-12 btn-lg" id="weixinfollowlink1">微信关注：软灵通</a>
        </div>
        <!-- E row -->
    </div>
    ...
    <script>
        $(function() {
			...
			if(navigator.userAgent.indexOf("MicroMessenger") == -1){
				$("#weixinfollowlink").attr("href","http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd");
				$("#weixinfollowlink1").attr("href","http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd");
				$("#weixinfollowlink2").attr("href","http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd");
				$("#weixinfollowlink3").attr("href","http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd");
			}
        });
    ...
    <div id="copy">
        <p class="text-center">
            <a href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd" id="weixinfollowlink3" style="color: #F00; font-weight: bold;font-size: 15px;">&copy; 软灵通（微信号：v918_cn）</a>
        </p>
    </div>
    <!-- E copy -->
