...
var _config = {
    ...
    shareData = {
        imgUrl: "http://www.v918.cn/vgames/games/se/assets/img/find.logo.png",
        timeLineLink: "http://www.v918.cn/vgames/games/se/",
        tTitle: "看你有多色？",
        tContent: "找出所有色块中颜色不同的一块。分享朋友圈，找到身边的色魔，关注微时代管家:v918_cn"
    };
! function() {
    var a = $("#box"),
        b = {
