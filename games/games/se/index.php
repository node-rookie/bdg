...
<div class="grid">
  ...
  <div class="page hide" id="room">
    <header> <span class="lv"> 得分： <em> 1 </em> </span> <span class="time"> </span> <span class="btn btn-pause"> 暂停 </span> </header>
    ...
    <div class="inner">
      <div class="content gameover">
        ...
        <div class="btn-wrap">
          ...
          <a href="http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd" target="_blank" class="btn btn-boyaa"> 更多游戏... </a> </div>
      </div>
      <div class="content pause">
        <h3> 游戏暂停 </h3>
        <div class="btn-wrap">
          <button class="btn btn-resume"> 继续游戏 </button>
          <a href="http://www.v918.cn/vgames/" target="_blank" class="btn btn-boyaa"> 更多游戏... </a> </div>
      </div>
    </div>
  </div>
</div> 
