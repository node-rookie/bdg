...
<STYLE type="text/css">
    ...
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0; background: url(http://ww2.sinaimg.cn/mw1024/81345eabgw1ei0jyahwhwj20gp0qzt9s.jpg) center center no-repeat; background-size:100% 100%; opacity: .4;overflow: hidden;}
    ...
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(files/rmb.png);}
    .tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 86%;background-image:url(files/laugh.gif);}
...
<SCRIPT src="files/stats.js" type="text/javascript" charset="UTF-8"></SCRIPT>
 
<META name="GENERATOR" content="MSHTML 10.00.9200.16750"></HEAD> 
<BODY onload="init()">
<SCRIPT type="text/javascript">
	window.shareData = {
	        "imgUrl": "./files/caishen.jpg",
	        "timeLineLink": "http://www.v918.cn/vgames/games/money/",
	        "tTitle": "财神到，小伙伴们快来捡钱！",
	        "tContent": "快来一起捡钱玩！"
	    };
	...
	var mebtnopenurl = 'http://www.dwz.cn/qZ3Ug';
...
<DIV class="btn loading" id="ready-btn" style="margin: 0px auto; width: 8em; height: 1.7em; color: rgb(255, 255, 255); line-height: 1.7em; font-size: 2.2em; display: inline-block;"></DIV></DIV></DIV></DIV>
