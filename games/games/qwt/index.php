...
var ds_urlhiscore="http://www.v918.cn/vgames"; 
...
<script language=javascript>
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/icon/qwt.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/qwt/",
		        "tTitle": "青蛙跳",
		        "tContent": "青蛙跳"
		};
                ...
                if (localStorage.myuid && myData.score != undefined) {
                    setTimeout(function(){
                        if (confirm("要将成绩提交到游戏排行榜吗？")) {
                            window.location = "http://www.v918.cn/vgames/games/qwt/index.html" + myData.gameid + "&uid=" + localStorage.myuid + "&score=" + myData.score + "&scorename=" + encodeURIComponent(myData.scoreName);
                        }
                        else {
