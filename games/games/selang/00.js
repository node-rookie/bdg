$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://www.v918.cn/vgames/games/';
...
window.shareData = {
    "imgUrl": "http://www.v918.cn/vgames/games/selang/icon.png",
    "timeLineLink": "http://www.v918.cn/vgames/games/selang/",
    "tTitle": "小心色狼-微时代游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！微时代游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s?__biz=MjM5MTYzNTg1MA==&mid=200926016&idx=1&sn=e48ddb1d423728fd30cf174f382dd932#rd"
        };
        helpCount = 0
    }
};
...
function dp_shareHelp(t) {
    ...
    document.title = "我花了" + t / 1000 + "秒！微时代游戏《小心色狼》还没解开！快来帮帮我吧！";
