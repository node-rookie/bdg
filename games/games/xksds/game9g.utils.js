...
game9gdialog.innerHTML='<header><h2 id="game9gtitle">微时代游戏</h2></header><section id="game9gcontent"></section><footer><a href="javascript:void(0)" id="game9gleftbtn">取消</a><a href="javascript:void(0)" id="game9grightbtn">确定</a></footer>';
...
// var domains=["caizy.cn", "caizy.cn", "caizy.cn", "frela.cn"];
var domain = domains[parseInt(Math.random() * domains.length)];
    if(window.shareData){
		window.shareData.timeLineLink = "http://"+ parseInt(Math.random()*100000) +"."+ myData.gameid +"."+domain+"/gamecenter.html?gameid=" + myData.gameid + (spid ? "&spid=" + spid : "") + (localStorage.myuid ? "&uid=" + localStorage.myuid : "");
