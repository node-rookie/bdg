...
IS_TOUCH, SCREEN_SHOW_ALL = !0; (function(a, d) {
	...
	a.showMoreGames = function(b) {
		if (null == e) {
			e = new createjs.Text("【更多游戏】", "28px Arial", "#404040");
			e.textAlign = "right";
...
function MyProgressBar(a, d, b) {
	...
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("微信公众号: 微时代管家", "38px Arial", "black");
	b.x = a / 2;
	b.y = 260;
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("(c)2014 微时代游戏\nwww.v918.cn/vgames", "32px Arial", "black");
	b.x = a / 2;
	b.y = d - 100;
	b.textAlign = "center";
	this.addChild(b)
