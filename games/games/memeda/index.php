...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>美女秀秀么么哒-微信朋友圈在线游戏-46465</title>
</head>
<body>
<div id="layout">
    <div id="loading" class="page show hide">loading</div>
    <div id="index" class="page show">
        <div class="app_name">show girl 么么哒</div>
        <div class="app_desc">爱我你就吻我吧</div>
        <div class="p_btns">
    ...
    <div id="game_pause" class="page hide">
        <div class="share">
            <img src="http://www.v918.cn/vgames/games/memeda/fx.png" width="160">
        </div>
        <div class="pause_txt">游戏暂停</div>
        <div class="p_btns">
            <span class="btn_continue js_game_continue">继续</span>
        </div>
        <div class="p_btns"><a href="http://www.v918.cn/vgames/" target="_blank" class="btn_download_game js_download_game">更多游戏</a></div>
...
<script type="text/html" id="tpl_gameover">
    ...
    <div class="p_btns">
        <a href="http://www.v918.cn/vgames/" target="_blank" class="btn_download_game js_download_game">更多游戏</a>
    </div>
