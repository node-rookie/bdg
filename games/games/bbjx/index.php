...
<html>
	...
	<body style="padding: 0; margin: 0; background: #000;">
		...
		window.shareData = {
		        "imgUrl": "http://www.v918.cn/vgames/icon/bbjx.png",
		        "timeLineLink": "http://www.v918.cn/vgames/games/bbjx",
		        "tTitle": "步步惊心-软灵通",
		        "tContent": "步步惊心-软灵通"
		};
		...
		function clickMore(){
			if((window.location+"").indexOf("zf",1)>0){
				window.location = "http://www.v918.cn/vgames/games/bbjx";
			 }
			 else{
				goHome();
			 }
		...
		<div id=share style="display: none">
			<img width=100% src="http://www.v918.cn/vgames/games/bbjx/share.png"
		...
		<div style="display: none;">
			...
			window.shareData.timeLineLink ="http://www.v918.cn/vgames/games/bbjx/";
                ...
                if (localStorage.myuid && myData.score != undefined) {
                    setTimeout(function(){
                        if (confirm("要将成绩提交到软灵通排行榜吗？")) {
                            window.location = "http://www.v918.cn/vgames/" + myData.gameid + "&uid=" + localStorage.myuid + "&score=" + myData.score + "&scorename=" + encodeURIComponent(myData.scoreName);
                        }
                        else {
