...
<head>
    ...
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0; background: url(bj.jpg) center center no-repeat; background-size:100% 100%; opacity: .4;overflow: hidden;}
    ...
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(b.jpg);}
    .tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 86%;background-image:url(t.jpg);}
...
<body onload="init()">
	...
	window.shareData = {
	        "imgUrl": "./t.jpg",
	        "timeLineLink": "http://www.v918.cn/vgames/jicilang/",
	        "tTitle": "你是一夜几次郎？",
	        "tContent": "史上最准的测试，怎么都停不下来的啊！"
	    };
	...
	function showGameScoreLayer(){
		...
		l.style.display = 'block';
		window.shareData.tTitle = '我是一夜'+_gameScore+'次郎，不服来挑战！！！'
	}
	...
	function shareText( score ){
		if( score <= 49 )
			return '呵呵！一夜'+score+'次郎！<br/><br/>郎君，你好棒，但还得加油哦，昨天试了一下，隔壁王老五比你多2次哦！';
		if( score <= 99 )
			return '酷！一夜'+score+'次郎！<br/><br/>郎君，你好坏哦，都快赶上我前任了哦，你比隔壁老六厉害多了！';
		if( score <= 149 )
			return '帅呆了！一夜'+score+'次郎！<br/><br/>郎君，爱死你了，么么哒，拆了这么多，摞起来都比小四高了！';
		if( score <= 199 )
			return '太牛了！一夜'+score+'次郎！<br/><br/>郎君，你是我见过最棒的男人，你击败了全国百分之99的男人，​奥巴马和金正恩都惊呆了！';

		return '膜拜ing！一夜'+score+'次郎！<br/><br/>你确定你是地球人？你是宇宙第一强人，再也没人能超越你了！';
	}
	...
	<div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
		<div style="padding:0 5%;">
			...
			<div id="GameScoreLayer-share" class="BOX">
				<div id="mebtn" class="btn BOX-S" onclick="window.open(mebtnopenurl)">&nbsp;郎君点我！</div>
			</div>
		</div>
	</div>
	...
	<div id="welcome" class="SHADE BOX-M">
		...
		<div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
			<div style="margin:0 8% 0 9%;">
				<div style="font-size:2.6em; color:#FEF002;">你是一夜几次郎？</div><br/>
				<div style="font-size:2.2em; color:#fff; line-height:1.5em;">从最下面的套套开始，<br/>20秒内看你能拆开多少个<br/>套套，你就是一夜几次郎！</div><br/><br/>
			...
			<br/><br/><br/>
				<div style="font-size:1.6em;"><a style="color:#fff" href="http://mp.weixin.qq.com/s?__biz=MjM5ODMzMjk5Nw==&mid=200442232&idx=1&sn=bb981cf0ec10bc9bf28f24179744f511&from=singlemessage&isappinstalled=0#rd">高智商手机魔术，敢挑战吗？</a></div>
			</div>
		</div>
	</div>
	...
	<div id="share-wx"><p style="text-align: right; padding-left: 10px;"><img src="2000.png" id="share-wx-img" style="max-width: 280px; padding-right: 25px;"></p></div>
<script type="text/javascript">
	if (isDesktop)
		document.write('</div>');
</script>
